...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Insights) domain
   */
  constructor(domain: InsightsBase) {
    super(domain, "v1");
  }

  /** calls - { Kandy.Insights.V1.CallListInstance } resource */
  protected _calls?: CallListInstance;
  /** callSummaries - { Kandy.Insights.V1.CallSummariesListInstance } resource */
  protected _callSummaries?: CallSummariesListInstance;
  /** conferences - { Kandy.Insights.V1.ConferenceListInstance } resource */
  protected _conferences?: ConferenceListInstance;
  /** rooms - { Kandy.Insights.V1.RoomListInstance } resource */
  protected _rooms?: RoomListInstance;
  /** settings - { Kandy.Insights.V1.SettingListInstance } resource */
