...
export type ParticipantKandyRealm =
  | "us1"
  | "us2"
  | "au1"
  | "br1"
...
interface ParticipantResource {
  ...
  media_region: ParticipantKandyRealm;
  properties: any;
...
export class ParticipantInstance {
  ...
  codecs: Array<ParticipantCodec>;
  /**
   * Reason the participant left the room. See [the list of possible values here](https://www.kandy.com/docs/video/video-log-analyzer/video-log-analyzer-api#end_reason).
   */
  endReason: string;
  /**
  ...
  errorCode: number;
  /**
   * Kandy error code dictionary link.
   */
  errorCodeUrl: string;
  mediaRegion: ParticipantKandyRealm;
  /**
   * Object containing information about the participant\'s data from the room. See [below](https://www.kandy.com/docs/video/video-log-analyzer/video-log-analyzer-api#properties) for more information.
   */
  properties: any;
  edgeLocation: ParticipantEdgeLocation;
  /**
   * Object containing information about the SDK name and version. See [below](https://www.kandy.com/docs/video/video-log-analyzer/video-log-analyzer-api#publisher_info) for more information.
   */
  publisherInfo: any;
  /**
