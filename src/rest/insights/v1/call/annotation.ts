...
export interface AnnotationContextUpdateOptions {
  ...
  callScore?: number;
  /** Specify any comments pertaining to the call. This of type string with a max limit of 100 characters. Kandy does not treat this field as PII, so don’t put any PII in here. */
  comment?: string;
  /** Associate this call with an incident or support ticket. This is of type string with a max limit of 100 characters. Kandy does not treat this field as PII, so don’t put any PII in here. */
  incident?: string;
}
