...
export interface ConferenceListInstanceEachOptions {
  ...
  /** Kandy region where the conference media was mixed. */
  mixerRegion?: string;
  /** Tags applied by Kandy for common potential configuration, quality, or performance issues. */
  tags?: string;
...
export class ConferenceInstance {
  ...
  /**
   * Potential issues detected by Kandy during the conference.
   */
  detectedIssues: any;
  /**
