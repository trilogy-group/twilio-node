...
interface PublicKeyPayload extends KandyResponsePayload {
...
export class PublicKeyInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Credential that the PublicKey resource belongs to.
   */
  accountSid: string;
  /**
  ...
  dateUpdated: Date;
  /**
   * The URI for this resource, relative to `https://accounts.kandy.com`
   */
  url: string;
