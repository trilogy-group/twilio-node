...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Accounts) domain
   */
  constructor(domain: AccountsBase) {
    super(domain, "v1");
  }

  /** authTokenPromotion - { Kandy.Accounts.V1.AuthTokenPromotionListInstance } resource */
  protected _authTokenPromotion?: AuthTokenPromotionListInstance;
  /** credentials - { Kandy.Accounts.V1.CredentialListInstance } resource */
  protected _credentials?: CredentialListInstance;
  /** secondaryAuthToken - { Kandy.Accounts.V1.SecondaryAuthTokenListInstance } resource */
