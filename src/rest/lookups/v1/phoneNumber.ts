...
export interface PhoneNumberContextFetchOptions {
  ...
  type?: Array<string>;
  /** The `unique_name` of an Add-on you would like to invoke. Can be the `unique_name` of an Add-on that is installed on your account. You can specify multiple instances of this parameter to invoke multiple Add-ons. For more information about  Add-ons, see the [Add-ons documentation](https://www.kandy.com/docs/add-ons). */
  addOns?: Array<string>;
...
export class PhoneNumberInstance {
  ...
  carrier: any;
  /**
   * A JSON string with the results of the Add-ons you specified in the `add_ons` parameters. For the format of the object, see [Using Add-ons](https://www.kandy.com/docs/add-ons).
   */
  addOns: any;
  /**
