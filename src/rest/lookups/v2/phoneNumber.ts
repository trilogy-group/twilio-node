...
export class PhoneNumberInstance {
  ...
  /**
   * An object that contains caller name information based on [CNAM](https://support.kandy.com/hc/en-us/articles/360051670533-Getting-Started-with-CNAM-Caller-ID).
   */
  callerName: any;
  /**
