...
export interface ServiceContextUpdateOptions {
  ...
  friendlyName?: string;
  /** The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) to use for APN Bindings. */
  apnCredentialSid?: string;
  /** The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) to use for GCM Bindings. */
  gcmCredentialSid?: string;
  /** The SID of the [Messaging Service](https://www.kandy.com/docs/sms/send-messages#messaging-services) to use for SMS Bindings. This parameter must be set in order to send SMS notifications. */
  messagingServiceSid?: string;
  /** Deprecated. */
  facebookMessengerPageId?: string;
  /** The protocol version to use for sending APNS notifications. Can be overridden on a Binding by Binding basis when creating a [Binding](https://www.kandy.com/docs/notify/api/binding-resource) resource. */
  defaultApnNotificationProtocolVersion?: string;
  /** The protocol version to use for sending GCM notifications. Can be overridden on a Binding by Binding basis when creating a [Binding](https://www.kandy.com/docs/notify/api/binding-resource) resource. */
  defaultGcmNotificationProtocolVersion?: string;
  /** The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) to use for FCM Bindings. */
  fcmCredentialSid?: string;
  /** The protocol version to use for sending FCM notifications. Can be overridden on a Binding by Binding basis when creating a [Binding](https://www.kandy.com/docs/notify/api/binding-resource) resource. */
...
export class ServiceInstance {
  ...
  fcmCredentialSid: string;
  /**
   * The SID of the [Messaging Service](https://www.kandy.com/docs/sms/send-messages#messaging-services) to use for SMS Bindings. In order to send SMS notifications this parameter has to be set.
   */
  messagingServiceSid: string;
  /**
   * Deprecated.
