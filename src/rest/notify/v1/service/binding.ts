...
export interface BindingListInstanceCreateOptions {
  /** The `identity` value that uniquely identifies the new resource\\\'s [User](https://www.kandy.com/docs/chat/rest/user-resource) within the [Service](https://www.kandy.com/docs/notify/api/service-resource). Up to 20 Bindings can be created for the same Identity in a given Service. */
  identity: string;
  /**  */
  ...
  tag?: Array<string>;
  /** The protocol version to use to send the notification. This defaults to the value of `default_xxxx_notification_protocol_version` for the protocol in the [Service](https://www.kandy.com/docs/notify/api/service-resource). The current version is `\\\"3\\\"` for `apn`, `fcm`, and `gcm` type Bindings. The parameter is not applicable to `sms` and `facebook-messenger` type Bindings as the data format is fixed. */
  notificationProtocolVersion?: string;
  /** The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) resource to be used to send notifications to this Binding. If present, this overrides the Credential specified in the Service resource. Applies to only `apn`, `fcm`, and `gcm` type Bindings. */
...
export interface BindingListInstanceEachOptions {
  ...
  endDate?: Date;
  /** The [User](https://www.kandy.com/docs/chat/rest/user-resource)\'s `identity` value of the resources to read. */
...
interface BindingPayload extends KandyResponsePayload {
...
export class BindingInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Binding resource.
   */
  accountSid: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/notify/api/service-resource) the resource is associated with.
   */
  serviceSid: string;
  /**
   * The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) resource to be used to send notifications to this Binding. If present, this overrides the Credential specified in the Service resource. Applicable only to `apn`, `fcm`, and `gcm` type Bindings.
   */
  credentialSid: string;
  /**
  ...
  endpoint: string;
  /**
   * The `identity` value that uniquely identifies the resource\'s [User](https://www.kandy.com/docs/chat/rest/user-resource) within the [Service](https://www.kandy.com/docs/notify/api/service-resource). Up to 20 Bindings can be created for the same Identity in a given Service.
   */
  identity: string;
  /**
