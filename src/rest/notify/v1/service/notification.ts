...
export interface NotificationListInstanceCreateOptions {
  ...
  /** The `identity` value that uniquely identifies the new resource\\\'s [User](https://www.kandy.com/docs/chat/rest/user-resource) within the [Service](https://www.kandy.com/docs/notify/api/service-resource). Delivery will be attempted only to Bindings with an Identity in this list. No more than 20 items are allowed in this list. */
...
export class NotificationInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Notification resource.
   */
  accountSid: string;
  /**
  ...
  tags: Array<string>;
  /**
   * The list of Segments to notify. The [Segment](https://www.kandy.com/docs/notify/api/segment-resource) resource is deprecated. Use the `tags` property, instead.
   */
  segments: Array<string>;
  priority: NotificationPriority;
  /**
