...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Video) domain
   */
  constructor(domain: VideoBase) {
    super(domain, "v1");
  }

  /** compositions - { Kandy.Video.V1.CompositionListInstance } resource */
  protected _compositions?: CompositionListInstance;
  /** compositionHooks - { Kandy.Video.V1.CompositionHookListInstance } resource */
  protected _compositionHooks?: CompositionHookListInstance;
  /** compositionSettings - { Kandy.Video.V1.CompositionSettingsListInstance } resource */
  protected _compositionSettings?: CompositionSettingsListInstance;
  /** recordings - { Kandy.Video.V1.RecordingListInstance } resource */
  protected _recordings?: RecordingListInstance;
  /** recordingSettings - { Kandy.Video.V1.RecordingSettingsListInstance } resource */
  protected _recordingSettings?: RecordingSettingsListInstance;
  /** rooms - { Kandy.Video.V1.RoomListInstance } resource */
