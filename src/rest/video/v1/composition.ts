...
export interface CompositionListInstanceCreateOptions {
  ...
  roomSid: string;
  /** An object that describes the video layout of the composition in terms of regions. See [Specifying Video Layouts](https://www.kandy.com/docs/video/api/compositions-resource#specifying-video-layouts) for more info. Please, be aware that either video_layout or audio_sources have to be provided to get a valid creation request */
  videoLayout?: any;
...
interface CompositionPayload extends KandyResponsePayload {
...
export class CompositionInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Composition resource.
   */
  accountSid: string;
  status: CompositionStatus;
  /**
  ...
  audioSourcesExcluded: Array<string>;
  /**
   * An object that describes the video layout of the composition in terms of regions. See [Specifying Video Layouts](https://www.kandy.com/docs/video/api/compositions-resource#specifying-video-layouts) for more info.
   */
  videoLayout: any;
  /**
