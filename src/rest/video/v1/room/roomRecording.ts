...
interface RoomRecordingPayload extends KandyResponsePayload {
...
export class RoomRecordingInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the RoomRecording resource.
   */
  accountSid: string;
  status: RoomRecordingStatus;
  /**
