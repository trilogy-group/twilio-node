...
export interface CompositionSettingsContextCreateOptions {
  ...
  /** The URL of the AWS S3 bucket where the compositions should be stored. We only support DNS-compliant URLs like `https://documentation-example-kandy-bucket/compositions`, where `compositions` is the path in which you want the compositions to be stored. This URL accepts only URI-valid characters, as described in the <a href=\\\'https://tools.ietf.org/html/rfc3986#section-2\\\'>RFC 3986</a>. */
  awsS3Url?: string;
...
export class CompositionSettingsInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the CompositionSettings resource.
   */
  accountSid: string;
  /**
  ...
  awsCredentialsSid: string;
  /**
   * The URL of the AWS S3 bucket where the compositions are stored. We only support DNS-compliant URLs like `https://documentation-example-kandy-bucket/compositions`, where `compositions` is the path in which you want the compositions to be stored. This URL accepts only URI-valid characters, as described in the <a href=\'https://tools.ietf.org/html/rfc3986#section-2\'>RFC 3986</a>.
   */
  awsS3Url: string;
  /**
