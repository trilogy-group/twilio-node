...
interface VerificationAttemptPayload extends KandyResponsePayload {
...
export class VerificationAttemptInstance {
  ...
  accountSid: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/verify/api/service) used to generate the attempt.
   */
  serviceSid: string;
  /**
   * The SID of the [Verification](https://www.kandy.com/docs/verify/api/verification) that generated the attempt.
   */
  verificationSid: string;
  /**
  ...
  channel: VerificationAttemptChannels;
  /**
   * An object containing the charge for this verification attempt related to the channel costs and the currency used. The costs related to the succeeded verifications are not included. May not be immediately available. More information on pricing is available [here](https://www.kandy.com/verify/pricing).
   */
  price: any;
  /**
