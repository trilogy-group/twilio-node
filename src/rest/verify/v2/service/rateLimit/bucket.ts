...
interface BucketPayload extends KandyResponsePayload {
...
export class BucketInstance {
  ...
  sid: string;
  /**
   * The Kandy-provided string that uniquely identifies the Rate Limit resource.
   */
  rateLimitSid: string;
  /**
  ...
  serviceSid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Rate Limit resource.
   */
  accountSid: string;
  /**
   * Maximum number of requests permitted in during the interval.
