...
export interface VerificationCheckListInstanceCreateOptions {
  ...
  code?: string;
  /** The phone number or [email](https://www.kandy.com/docs/verify/email) to verify. Either this parameter or the `verification_sid` must be specified. Phone numbers must be in [E.164 format](https://www.kandy.com/docs/glossary/what-e164). */
  to?: string;
  /** A SID that uniquely identifies the Verification Check. Either this parameter or the `to` phone number/[email](https://www.kandy.com/docs/verify/email) must be specified. */
...
export class VerificationCheckInstance {
  ...
  serviceSid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the VerificationCheck resource.
   */
  accountSid: string;
  /**
