...
export interface MessagingConfigurationContextUpdateOptions {
  /** The SID of the [Messaging Service](https://www.kandy.com/docs/sms/services/api) to be used to send SMS to the country of this configuration. */
...
interface MessagingConfigurationPayload extends KandyResponsePayload {
...
export class MessagingConfigurationInstance {
  ...
  accountSid: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/verify/api/service) that the resource is associated with.
   */
  serviceSid: string;
  /**
   * The [ISO-3166-1](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code of the country this configuration will be applied to. If this is a global configuration, Country will take the value `all`.
