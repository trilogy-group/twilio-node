...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Conversations) domain
   */
  constructor(domain: ConversationsBase) {
    super(domain, "v1");
  }

  /** addressConfigurations - { Kandy.Conversations.V1.AddressConfigurationListInstance } resource */
  protected _addressConfigurations?: AddressConfigurationListInstance;
  /** configuration - { Kandy.Conversations.V1.ConfigurationListInstance } resource */
  protected _configuration?: ConfigurationListInstance;
  /** conversations - { Kandy.Conversations.V1.ConversationListInstance } resource */
  protected _conversations?: ConversationListInstance;
  /** credentials - { Kandy.Conversations.V1.CredentialListInstance } resource */
  protected _credentials?: CredentialListInstance;
  /** participantConversations - { Kandy.Conversations.V1.ParticipantConversationListInstance } resource */
  protected _participantConversations?: ParticipantConversationListInstance;
  /** roles - { Kandy.Conversations.V1.RoleListInstance } resource */
  protected _roles?: RoleListInstance;
  /** services - { Kandy.Conversations.V1.ServiceListInstance } resource */
  protected _services?: ServiceListInstance;
  /** users - { Kandy.Conversations.V1.UserListInstance } resource */
