...
interface UserConversationPayload extends KandyResponsePayload {
...
export class UserConversationInstance {
  ...
  chatServiceSid: string;
  /**
   * The unique ID of the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for this User Conversation.
   */
  conversationSid: string;
  /**
  ...
  lastReadMessageIndex: number;
  /**
   * The unique ID of the [participant](https://www.kandy.com/docs/conversations/api/conversation-participant-resource) the user conversation belongs to.
   */
  participantSid: string;
  /**
   * The unique string that identifies the [User resource](https://www.kandy.com/docs/conversations/api/user-resource).
   */
  userSid: string;
  /**
