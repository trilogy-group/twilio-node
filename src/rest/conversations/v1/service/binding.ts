...
export interface BindingListInstanceEachOptions {
  ...
  /** The identity of a [Conversation User](https://www.kandy.com/docs/conversations/api/user-resource) this binding belongs to. See [access tokens](https://www.kandy.com/docs/conversations/create-tokens) for more details. */
...
export class BindingInstance {
  ...
  sid: string;
  /**
   * The unique ID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for this binding.
   */
  accountSid: string;
  /**
   * The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Binding resource is associated with.
   */
  chatServiceSid: string;
  /**
   * The SID of the [Credential](https://www.kandy.com/docs/conversations/api/credential-resource) for the binding. See [push notification configuration](https://www.kandy.com/docs/chat/push-notification-configuration) for more info.
   */
  ...
  endpoint: string;
  /**
   * The application-defined string that uniquely identifies the [Conversation User](https://www.kandy.com/docs/conversations/api/user-resource) within the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource). See [access tokens](https://www.kandy.com/docs/conversations/create-tokens) for more info.
   */
  identity: string;
  bindingType: BindingBindingType;
  /**
   * The [Conversation message types](https://www.kandy.com/docs/chat/push-notification-configuration#push-types) the binding is subscribed to.
   */
