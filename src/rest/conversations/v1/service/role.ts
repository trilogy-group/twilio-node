...
interface RolePayload extends KandyResponsePayload {
  roles: RoleResource[];
}
...
export class RoleInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Role resource.
   */
  accountSid: string;
  /**
   * The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Role resource is associated with.
   */
  chatServiceSid: string;
  /**
