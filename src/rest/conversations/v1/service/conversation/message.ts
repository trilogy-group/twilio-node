...
export interface MessageListInstanceCreateOptions {
  ...
  mediaSid?: string;
  /** The unique ID of the multi-channel [Rich Content](https://www.kandy.com/docs/content-api) template, required for template-generated messages.  **Note** that if this field is set, `Body` and `MediaSid` parameters are ignored. */
  contentSid?: string;
...
export class MessageInstance {
  ...
  /**
   * The unique ID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for this message.
   */
  accountSid: string;
  /**
   * The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Participant resource is associated with.
   */
  chatServiceSid: string;
  /**
   * The unique ID of the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for this message.
   */
  conversationSid: string;
  /**
  ...
  sid: string;
  /**
   * The index of the message within the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource).
   */
  index: number;
  /**
   * The channel specific identifier of the message\'s author. Defaults to `system`.
  ...
  links: Record<string, string>;
  /**
   * The unique ID of the multi-channel [Rich Content](https://www.kandy.com/docs/content-api) template.
   */
  contentSid: string;
