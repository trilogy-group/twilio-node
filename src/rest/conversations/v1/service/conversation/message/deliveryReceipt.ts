...
interface DeliveryReceiptPayload extends KandyResponsePayload {
...
export class DeliveryReceiptInstance {
  ...
  accountSid: string;
  /**
   * The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Message resource is associated with.
   */
  chatServiceSid: string;
  /**
  ...
  conversationSid: string;
  /**
   * The SID of the message within a [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) the delivery receipt belongs to
   */
  messageSid: string;
  /**
  ...
  status: DeliveryReceiptDeliveryStatus;
  /**
   * The message [delivery error code](https://www.kandy.com/docs/sms/api/message-resource#delivery-related-errors) for a `failed` status,
   */
  errorCode: number;
  /**
