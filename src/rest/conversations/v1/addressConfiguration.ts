...
interface AddressConfigurationPayload extends KandyResponsePayload {
...
export class AddressConfigurationInstance {
  ...
  sid: string;
  /**
   * The unique ID of the [Account](https://www.kandy.com/docs/iam/api/account) the address belongs to
   */
  accountSid: string;
  /**
