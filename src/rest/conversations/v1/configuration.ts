...
export interface ConfigurationContextUpdateOptions {
  /** The SID of the default [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to use when creating a conversation. */
  defaultChatServiceSid?: string;
  /** The SID of the default [Messaging Service](https://www.kandy.com/docs/sms/services/api) to use when creating a conversation. */
...
export class ConfigurationInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for this configuration.
   */
  accountSid: string;
  /**
   * The SID of the default [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) used when creating a conversation.
   */
  defaultChatServiceSid: string;
  /**
   * The SID of the default [Messaging Service](https://www.kandy.com/docs/sms/services/api) used when creating a conversation.
   */
  defaultMessagingServiceSid: string;
  /**
   * Default ISO8601 duration when conversation will be switched to `inactive` state. Minimum value for this timer is 1 minute.
