...
export interface ConversationContextRemoveOptions {
  ...
  xKandyWebhookEnabled?: ConversationWebhookEnabledType;
}
...
export interface ConversationContextUpdateOptions {
  ...
  attributes?: string;
  /** The unique ID of the [Messaging Service](https://www.kandy.com/docs/sms/services/api) this conversation belongs to. */
...
interface ConversationPayload extends KandyResponsePayload {
...
export class ConversationInstance {
  ...
  url: string;
  /**
   * Contains absolute URLs to access the [participants](https://www.kandy.com/docs/conversations/api/conversation-participant-resource), [messages](https://www.kandy.com/docs/conversations/api/conversation-message-resource) and [webhooks](https://www.kandy.com/docs/conversations/api/conversation-scoped-webhook-resource) of this conversation.
   */
  links: Record<string, string>;
  bindings: any;
