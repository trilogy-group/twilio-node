...
export class MessageInstance {
  ...
  sid: string;
  /**
   * The index of the message within the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource).  Indices may skip numbers, but will always be in order of when the message was received.
   */
  index: number;
  /**
   * The channel specific identifier of the message\'s author. Defaults to `system`.
