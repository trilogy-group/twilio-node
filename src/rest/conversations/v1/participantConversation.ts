...
interface ParticipantConversationPayload extends KandyResponsePayload {
...
export class ParticipantConversationInstance {
  ...
  /**
   * The unique ID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for this conversation.
   */
  accountSid: string;
  /**
   * The unique ID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) this conversation belongs to.
   */
  chatServiceSid: string;
  /**
   * The unique ID of the [Participant](https://www.kandy.com/docs/conversations/api/conversation-participant-resource).
   */
  participantSid: string;
  /**
   * The unique string that identifies the conversation participant as [Conversation User](https://www.kandy.com/docs/conversations/api/user-resource).
   */
  ...
  /**
   * The unique ID of the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) this Participant belongs to.
   */
  ...
  /**
   * Contains absolute URLs to access the [participant](https://www.kandy.com/docs/conversations/api/conversation-participant-resource) and [conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) of this conversation.
   */
  links: Record<string, string>;
