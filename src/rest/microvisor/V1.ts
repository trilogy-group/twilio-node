...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Microvisor) domain
   */
  constructor(domain: MicrovisorBase) {
    super(domain, "v1");
  }

  /** accountConfigs - { Kandy.Microvisor.V1.AccountConfigListInstance } resource */
  protected _accountConfigs?: AccountConfigListInstance;
  /** accountSecrets - { Kandy.Microvisor.V1.AccountSecretListInstance } resource */
  protected _accountSecrets?: AccountSecretListInstance;
  /** apps - { Kandy.Microvisor.V1.AppListInstance } resource */
  protected _apps?: AppListInstance;
  /** devices - { Kandy.Microvisor.V1.DeviceListInstance } resource */
