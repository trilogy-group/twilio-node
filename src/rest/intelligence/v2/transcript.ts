...
interface TranscriptPayload extends KandyResponsePayload {
...
export class TranscriptInstance {
  ...
  channel: any;
  /**
   * Data logging allows Kandy to improve the quality of the speech recognition through using customer data to refine its speech recognition models.
   */
  dataLogging: boolean;
  /**
