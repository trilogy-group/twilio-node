...
export interface WorkspaceContextUpdateOptions {
  ...
  /** The URL we should call when an event occurs. See [Workspace Events](https://www.kandy.com/docs/taskrouter/api/event) for more information. This parameter supports Kandy\\\'s [Webhooks (HTTP callbacks) Connection Overrides](https://www.kandy.com/docs/usage/webhooks/webhooks-connection-overrides). */
...
interface WorkspacePayload extends KandyResponsePayload {
...
export class WorkspaceInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Workspace resource.
   */
  accountSid: string;
  /**
