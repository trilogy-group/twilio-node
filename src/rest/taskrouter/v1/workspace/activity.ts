...
interface ActivityPayload extends KandyResponsePayload {
...
export class ActivityInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Activity resource.
   */
  accountSid: string;
  /**
