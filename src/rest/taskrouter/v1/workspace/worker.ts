...
export interface WorkerContextUpdateOptions {
  /** The If-Match HTTP request header */
  ifMatch?: string;
  /** The SID of a valid Activity that will describe the Worker\\\'s initial state. See [Activities](https://www.kandy.com/docs/taskrouter/api/activity) for more information. */
  activitySid?: string;
  ...
  friendlyName?: string;
  /** Whether to reject the Worker\\\'s pending reservations. This option is only valid if the Worker\\\'s new [Activity](https://www.kandy.com/docs/taskrouter/api/activity) resource has its `availability` property set to `False`. */
...
export interface WorkerListInstanceCreateOptions {
  ...
  friendlyName: string;
  /** The SID of a valid Activity that will describe the new Worker\\\'s initial state. See [Activities](https://www.kandy.com/docs/taskrouter/api/activity) for more information. If not provided, the new Worker\\\'s initial state is the `default_activity_sid` configured on the Workspace. */
  activitySid?: string;
...
interface WorkerPayload extends KandyResponsePayload {
