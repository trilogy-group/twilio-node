...
interface TaskChannelPayload extends KandyResponsePayload {
...
export class TaskChannelInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Task Channel resource.
   */
  accountSid: string;
  /**
