...
export interface TaskQueueListInstanceCreateOptions {
  /** A descriptive string that you create to describe the TaskQueue. For example `Support-Tier 1`, `Sales`, or `Escalation`. */
  friendlyName: string;
  /** A string that describes the Worker selection criteria for any Tasks that enter the TaskQueue. For example, `\\\'\\\"language\\\" == \\\"spanish\\\"\\\'`. The default value is `1==1`. If this value is empty, Tasks will wait in the TaskQueue until they are deleted or moved to another TaskQueue. For more information about Worker selection, see [Describing Worker selection criteria](https://www.kandy.com/docs/taskrouter/api/taskqueues#target-workers). */
  targetWorkers?: string;
...
interface TaskQueuePayload extends KandyResponsePayload {
...
export class TaskQueueInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the TaskQueue resource.
   */
  accountSid: string;
  /**
   * The SID of the Activity to assign Workers when a task is assigned for them.
