...
export interface ReservationContextUpdateOptions {
  ...
  /** The contact URI of the worker when executing a Dequeue instruction. Can be the URI of the Kandy Client, the SIP URI for Programmable SIP, or the [E.164](https://www.kandy.com/docs/glossary/what-e164) formatted phone number, depending on the destination. */
  dequeueTo?: string;
  ...
  callTimeout?: number;
  /** The contact URI of the worker when executing a Call instruction. Can be the URI of the Kandy Client, the SIP URI for Programmable SIP, or the [E.164](https://www.kandy.com/docs/glossary/what-e164) formatted phone number, depending on the destination. */
  callTo?: string;
  ...
  redirectUrl?: string;
  /** The Contact URI of the worker when executing a Conference instruction. Can be the URI of the Kandy Client, the SIP URI for Programmable SIP, or the [E.164](https://www.kandy.com/docs/glossary/what-e164) formatted phone number, depending on the destination. */
  to?: string;
...
interface ReservationPayload extends KandyResponsePayload {
...
export class ReservationInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the WorkerReservation resource.
   */
  accountSid: string;
  /**
