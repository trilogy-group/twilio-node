...
export interface WorkflowContextUpdateOptions {
  ...
  friendlyName?: string;
  /** The URL from your application that will process task assignment events. See [Handling Task Assignment Callback](https://www.kandy.com/docs/taskrouter/handle-assignment-callbacks) for more details. */
  ...
  /** A JSON string that contains the rules to apply to the Workflow. See [Configuring Workflows](https://www.kandy.com/docs/taskrouter/workflow-configuration) for more information. */
...
interface WorkflowPayload extends KandyResponsePayload {
...
export class WorkflowInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Workflow resource.
   */
  accountSid: string;
  /**
  ...
  assignmentCallbackUrl: string;
  /**
   * A JSON string that contains the Workflow\'s configuration. See [Configuring Workflows](https://www.kandy.com/docs/taskrouter/workflow-configuration) for more information.
   */
  configuration: string;
  /**
