...
export interface ExecutionListInstanceCreateOptions {
  ...
  to: string;
  /** The Kandy phone number to send messages or initiate calls from during the Flow\\\'s Execution. Available as variable `{{flow.channel.address}}`. For SMS, this can also be a Messaging Service SID. */
  from: string;
...
interface ExecutionPayload extends KandyResponsePayload {
...
export class ExecutionInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Execution resource.
   */
  accountSid: string;
  /**
   * The SID of the Flow.
