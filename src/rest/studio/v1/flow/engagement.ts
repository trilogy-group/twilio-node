...
export interface EngagementListInstanceCreateOptions {
  ...
  to: string;
  /** The Kandy phone number to send messages or initiate calls from during the Flow Engagement. Available as variable `{{flow.channel.address}}` */
  from: string;
...
interface EngagementPayload extends KandyResponsePayload {
...
export class EngagementInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Engagement resource.
   */
  accountSid: string;
  /**
   * The SID of the Flow.
