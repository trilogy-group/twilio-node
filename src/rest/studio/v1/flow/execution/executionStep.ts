...
interface ExecutionStepPayload extends KandyResponsePayload {
...
export class ExecutionStepInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ExecutionStep resource.
   */
  accountSid: string;
  /**
   * The SID of the Flow.
