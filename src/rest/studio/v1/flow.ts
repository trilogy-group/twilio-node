...
export class FlowContextImpl implements FlowContext {
  ...
  get engagements(): EngagementListInstance {
    this._engagements =
      this._engagements ||
      EngagementListInstance(this._version, this._solution.sid);
...
interface FlowPayload extends KandyResponsePayload {
  flows: FlowResource[];
}
...
export class FlowInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Flow resource.
   */
  accountSid: string;
  /**
...
export function FlowListInstance(version: V1): FlowListInstance {
