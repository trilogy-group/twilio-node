...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.IpMessaging) domain
   */
  constructor(domain: IpMessagingBase) {
    super(domain, "v1");
  }

  /** credentials - { Kandy.IpMessaging.V1.CredentialListInstance } resource */
  protected _credentials?: CredentialListInstance;
  /** services - { Kandy.IpMessaging.V1.ServiceListInstance } resource */
