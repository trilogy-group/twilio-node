...
export interface ExportConfigurationContextUpdateOptions {
  /** If true, Kandy will automatically generate every day\\\'s file when the day is over. */
  enabled?: boolean;
  /** Stores the URL destination for the method specified in webhook_method. */
  webhookUrl?: string;
  /** Sets whether Kandy should call a webhook URL when the automatic generation is complete, using GET or POST. The actual destination is set in the webhook_url */
