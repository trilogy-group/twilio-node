...
interface MediaRecordingPayload extends KandyResponsePayload {
...
export class MediaRecordingInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the MediaRecording resource.
   */
  accountSid: string;
  /**
  ...
  status: MediaRecordingStatus;
  /**
   * The URL to which Kandy will send asynchronous webhook requests for every MediaRecording event. See [Status Callbacks](/docs/live/status-callbacks) for more details.
   */
