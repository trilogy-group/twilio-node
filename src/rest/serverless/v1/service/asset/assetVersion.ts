...
interface AssetVersionPayload extends KandyResponsePayload {
...
export class AssetVersionInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Asset Version resource.
   */
  accountSid: string;
  /**
