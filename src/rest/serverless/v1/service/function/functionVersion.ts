...
interface FunctionVersionPayload extends KandyResponsePayload {
...
export class FunctionVersionInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Function Version resource.
   */
  accountSid: string;
  /**
