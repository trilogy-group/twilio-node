...
interface VariablePayload extends KandyResponsePayload {
...
export class VariableInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Variable resource.
   */
  accountSid: string;
  /**
