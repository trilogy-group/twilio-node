...
interface EnvironmentPayload extends KandyResponsePayload {
...
export class EnvironmentInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Environment resource.
   */
  accountSid: string;
  /**
