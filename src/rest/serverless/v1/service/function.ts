...
interface FunctionPayload extends KandyResponsePayload {
...
export class FunctionInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Function resource.
   */
  accountSid: string;
  /**
