...
export interface ShortCodeContextUpdateOptions {
  /** Whether the short code should be reserved and not be assigned to a participant using proxy pool logic. See [Reserved Phone Numbers](https://www.kandy.com/docs/proxy/reserved-phone-numbers) for more information. */
  isReserved?: boolean;
}
...
export interface ShortCodeListInstanceCreateOptions {
  /** The SID of a Kandy [ShortCode](https://www.kandy.com/docs/sms/api/short-code) resource that represents the short code you would like to assign to your Proxy Service. */
  sid: string;
}
/**
...
interface ShortCodePayload extends KandyResponsePayload {
...
export class ShortCodeInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ShortCode resource.
   */
  accountSid: string;
  /**
   * The SID of the ShortCode resource\'s parent [Service](https://www.kandy.com/docs/proxy/api/service) resource.
   */
  serviceSid: string;
  /**
