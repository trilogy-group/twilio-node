...
export interface PhoneNumberContextUpdateOptions {
  /** Whether the phone number should be reserved and not be assigned to a participant using proxy pool logic. See [Reserved Phone Numbers](https://www.kandy.com/docs/proxy/reserved-phone-numbers) for more information. */
  isReserved?: boolean;
}
...
export interface PhoneNumberListInstanceCreateOptions {
  /** The SID of a Kandy [IncomingPhoneNumber](https://www.kandy.com/docs/phone-numbers/api/incomingphonenumber-resource) resource that represents the Kandy Number you would like to assign to your Proxy Service. */
  sid?: string;
  /** The phone number in [E.164](https://www.kandy.com/docs/glossary/what-e164) format.  E.164 phone numbers consist of a + followed by the country code and subscriber number without punctuation characters. For example, +14155551234. */
  phoneNumber?: string;
  /** Whether the new phone number should be reserved and not be assigned to a participant using proxy pool logic. See [Reserved Phone Numbers](https://www.kandy.com/docs/proxy/reserved-phone-numbers) for more information. */
  isReserved?: boolean;
}
/**
...
interface PhoneNumberPayload extends KandyResponsePayload {
...
export class PhoneNumberInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the PhoneNumber resource.
   */
  accountSid: string;
  /**
   * The SID of the PhoneNumber resource\'s parent [Service](https://www.kandy.com/docs/proxy/api/service) resource.
   */
  serviceSid: string;
  /**
  ...
  dateUpdated: Date;
  /**
   * The phone number in [E.164](https://www.kandy.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number.
   */
  phoneNumber: string;
  /**
  ...
  isReserved: boolean;
  /**
   * The number of open session assigned to the number. See the [How many Phone Numbers do I need?](https://www.kandy.com/docs/proxy/phone-numbers-needed) guide for more information.
   */
  inUse: number;
