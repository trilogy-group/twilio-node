...
interface SessionPayload extends KandyResponsePayload {
...
export class SessionInstance {
  ...
  sid: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/proxy/api/service) the session is associated with.
   */
  serviceSid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Session resource.
   */
  accountSid: string;
  /**
