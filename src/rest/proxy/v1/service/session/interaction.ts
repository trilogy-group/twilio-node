...
interface InteractionPayload extends KandyResponsePayload {
...
export class InteractionInstance {
  ...
  sid: string;
  /**
   * The SID of the parent [Session](https://www.kandy.com/docs/proxy/api/session) resource.
   */
  sessionSid: string;
  /**
   * The SID of the parent [Service](https://www.kandy.com/docs/proxy/api/service) resource.
   */
  serviceSid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Interaction resource.
   */
  accountSid: string;
  /**
  ...
  type: InteractionType;
  /**
   * The SID of the inbound [Participant](https://www.kandy.com/docs/proxy/api/participant) resource.
   */
  inboundParticipantSid: string;
  /**
   * The SID of the inbound resource; either the [Call](https://www.kandy.com/docs/voice/api/call-resource) or [Message](https://www.kandy.com/docs/sms/api/message.
   */
  inboundResourceSid: string;
  inboundResourceStatus: InteractionResourceStatus;
  /**
   * The inbound resource type. Can be [Call](https://www.kandy.com/docs/voice/api/call-resource) or [Message](https://www.kandy.com/docs/sms/api/message-resource).
   */
  inboundResourceType: string;
  /**
   * The URL of the Kandy inbound resource
   */
  inboundResourceUrl: string;
  /**
   * The SID of the outbound [Participant](https://www.kandy.com/docs/proxy/api/participant)).
   */
  outboundParticipantSid: string;
  /**
   * The SID of the outbound resource; either the [Call](https://www.kandy.com/docs/voice/api/call-resource) or [Message](https://www.kandy.com/docs/sms/api/message-resource).
   */
  outboundResourceSid: string;
  outboundResourceStatus: InteractionResourceStatus;
  /**
   * The outbound resource type. Can be: [Call](https://www.kandy.com/docs/voice/api/call-resource) or [Message](https://www.kandy.com/docs/sms/api/message-resource).
   */
  outboundResourceType: string;
  /**
   * The URL of the Kandy outbound resource.
   */
