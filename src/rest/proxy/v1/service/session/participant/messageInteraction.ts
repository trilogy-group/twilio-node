...
interface MessageInteractionPayload extends KandyResponsePayload {
...
export class MessageInteractionInstance {
  ...
  serviceSid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the MessageInteraction resource.
   */
  accountSid: string;
  /**
  ...
  type: MessageInteractionType;
  /**
   * The SID of the [Participant](https://www.kandy.com/docs/proxy/api/participant) resource.
   */
  participantSid: string;
  /**
  ...
  /**
   * The SID of the outbound [Participant](https://www.kandy.com/docs/proxy/api/participant) resource.
   */
  outboundParticipantSid: string;
  /**
   * The SID of the outbound [Message](https://www.kandy.com/docs/sms/api/message-resource) resource.
   */
  ...
  /**
   * The URL of the Kandy message resource.
   */
