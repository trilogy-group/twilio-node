...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Supersim) domain
   */
  constructor(domain: SupersimBase) {
    super(domain, "v1");
  }

  /** esimProfiles - { Kandy.Supersim.V1.EsimProfileListInstance } resource */
  protected _esimProfiles?: EsimProfileListInstance;
  /** fleets - { Kandy.Supersim.V1.FleetListInstance } resource */
  protected _fleets?: FleetListInstance;
  /** ipCommands - { Kandy.Supersim.V1.IpCommandListInstance } resource */
  protected _ipCommands?: IpCommandListInstance;
  /** networks - { Kandy.Supersim.V1.NetworkListInstance } resource */
  protected _networks?: NetworkListInstance;
  /** networkAccessProfiles - { Kandy.Supersim.V1.NetworkAccessProfileListInstance } resource */
  protected _networkAccessProfiles?: NetworkAccessProfileListInstance;
  /** settingsUpdates - { Kandy.Supersim.V1.SettingsUpdateListInstance } resource */
  protected _settingsUpdates?: SettingsUpdateListInstance;
  /** sims - { Kandy.Supersim.V1.SimListInstance } resource */
  protected _sims?: SimListInstance;
  /** smsCommands - { Kandy.Supersim.V1.SmsCommandListInstance } resource */
  protected _smsCommands?: SmsCommandListInstance;
  /** usageRecords - { Kandy.Supersim.V1.UsageRecordListInstance } resource */
