...
export class UsageRecordInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that incurred the usage.
   */
  accountSid: string;
  /**
