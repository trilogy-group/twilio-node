...
interface NetworkAccessProfilePayload extends KandyResponsePayload {
...
export class NetworkAccessProfileInstance {
  ...
  uniqueName: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that the Network Access Profile belongs to.
   */
  accountSid: string;
  /**
