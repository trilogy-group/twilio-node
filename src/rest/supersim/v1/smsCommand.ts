...
export interface SmsCommandListInstanceCreateOptions {
  /** The `sid` or `unique_name` of the [SIM](https://www.kandy.com/docs/iot/supersim/api/sim-resource) to send the SMS Command to. */
  sim: string;
...
export interface SmsCommandListInstanceEachOptions {
  ...
  sim?: string;
  /** The status of the SMS Command. Can be: `queued`, `sent`, `delivered`, `received` or `failed`. See the [SMS Command Status Values](https://www.kandy.com/docs/iot/supersim/api/smscommand-resource#status-values) for a description of each. */
...
interface SmsCommandPayload extends KandyResponsePayload {
...
export class SmsCommandInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the SMS Command resource.
   */
  accountSid: string;
  /**
   * The SID of the [SIM](https://www.kandy.com/docs/iot/supersim/api/sim-resource) that this SMS Command was sent to or from.
   */
  simSid: string;
  /**
