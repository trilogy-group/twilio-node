...
export interface AssistantContextUpdateOptions {
  ...
  /** The JSON string that defines the Assistant\\\'s [style sheet](https://www.kandy.com/docs/autopilot/api/assistant/stylesheet) */
  styleSheet?: any;
  /** A JSON object that defines the Assistant\\\'s [default tasks](https://www.kandy.com/docs/autopilot/api/assistant/defaults) for various scenarios, including initiation actions and fallback tasks. */
  defaults?: any;
...
interface AssistantPayload extends KandyResponsePayload {
...
export class AssistantInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Assistant resource.
   */
  accountSid: string;
  /**
