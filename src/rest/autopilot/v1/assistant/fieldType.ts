...
interface FieldTypePayload extends KandyResponsePayload {
...
export class FieldTypeInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the FieldType resource.
   */
  accountSid: string;
  /**
