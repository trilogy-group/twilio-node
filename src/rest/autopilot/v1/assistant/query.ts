...
export interface QueryContextUpdateOptions {
  /** The SID of an optional reference to the [Sample](https://www.kandy.com/docs/autopilot/api/task-sample) created from the query. */
  sampleSid?: string;
...
export interface QueryListInstanceCreateOptions {
  ...
  tasks?: string;
  /** The SID or unique name of the [Model Build](https://www.kandy.com/docs/autopilot/api/model-build) to be queried. */
  modelBuild?: string;
}
/**
...
export interface QueryListInstanceEachOptions {
  ...
  status?: string;
  /** The SID of the [Dialogue](https://www.kandy.com/docs/autopilot/api/dialogue). */
  dialogueSid?: string;
...
interface QueryPayload extends KandyResponsePayload {
...
export class QueryInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Query resource.
   */
  accountSid: string;
  /**
  ...
  dateUpdated: Date;
  /**
   * The natural language analysis results that include the [Task](https://www.kandy.com/docs/autopilot/api/task) recognized and a list of identified [Fields](https://www.kandy.com/docs/autopilot/api/task-field).
   */
  results: any;
  /**
  ...
  language: string;
  /**
   * The SID of the [Model Build](https://www.kandy.com/docs/autopilot/api/model-build) queried.
   */
  ...
  sampleSid: string;
  /**
   * The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the resource.
   */
  assistantSid: string;
  /**
