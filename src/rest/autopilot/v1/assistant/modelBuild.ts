...
interface ModelBuildPayload extends KandyResponsePayload {
...
export class ModelBuildInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ModelBuild resource.
   */
  accountSid: string;
  /**
  ...
  /**
   * If the `status` for the model build is `failed`, this value is a code to more information about the failure. This value will be null for all other statuses. See [error code dictionary](https://www.kandy.com/docs/api/errors) for a description of the error.
   */
  errorCode: number;
