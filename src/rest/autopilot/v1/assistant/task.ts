...
export interface TaskContextUpdateOptions {
  ...
  uniqueName?: string;
  /** The JSON string that specifies the [actions](https://www.kandy.com/docs/autopilot/actions) that instruct the Assistant on how to perform the task. */
  actions?: any;
...
export interface TaskListInstanceCreateOptions {
  ...
  friendlyName?: string;
  /** The JSON string that specifies the [actions](https://www.kandy.com/docs/autopilot/actions) that instruct the Assistant on how to perform the task. It is optional and not unique. */
  actions?: any;
  /** The URL from which the Assistant can fetch actions. */
  actionsUrl?: string;
}
...
interface TaskPayload extends KandyResponsePayload {
  tasks: TaskResource[];
}
...
export class TaskInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Task resource.
   */
  accountSid: string;
  /**
