...
export class TaskStatisticsInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the TaskStatistics resource.
   */
  accountSid: string;
  /**
  ...
  assistantSid: string;
  /**
   * The SID of the [Task](https://www.kandy.com/docs/autopilot/api/task) for which the statistics were collected.
   */
  taskSid: string;
  /**
   * The total number of [Samples](https://www.kandy.com/docs/autopilot/api/task-sample) associated with the Task.
   */
  samplesCount: number;
  /**
   * The total number of [Fields](https://www.kandy.com/docs/autopilot/api/task-field) associated with the Task.
   */
  fieldsCount: number;
  /**
