...
export interface SampleContextUpdateOptions {
  ...
  language?: string;
  /** The text example of how end users might express the task. The sample can contain [Field tag blocks](https://www.kandy.com/docs/autopilot/api/task-sample#field-tagging). */
  taggedText?: string;
...
interface SamplePayload extends KandyResponsePayload {
...
export class SampleInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Sample resource.
   */
  accountSid: string;
  /**
  ...
  dateUpdated: Date;
  /**
   * The SID of the [Task](https://www.kandy.com/docs/autopilot/api/task) associated with the resource.
   */
  taskSid: string;
  /**
   * The [ISO language-country](https://docs.oracle.com/cd/E13214_01/wli/docs92/xref/xqisocodes.html) string that specifies the language used for the sample. For example: `en-US`.
