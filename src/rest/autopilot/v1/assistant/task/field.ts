...
export interface FieldListInstanceCreateOptions {
  /** The Field Type of the new field. Can be: a [Built-in Field Type](https://www.kandy.com/docs/autopilot/built-in-field-types), the `unique_name`, or the `sid` of a custom Field Type. */
  fieldType: string;
...
interface FieldPayload extends KandyResponsePayload {
...
export class FieldInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Field resource.
   */
  accountSid: string;
  /**
  ...
  dateUpdated: Date;
  /**
   * The Field Type of the field. Can be: a [Built-in Field Type](https://www.kandy.com/docs/autopilot/built-in-field-types), the unique_name, or the SID of a custom Field Type.
   */
  fieldType: string;
  /**
   * The SID of the [Task](https://www.kandy.com/docs/autopilot/api/task) resource associated with this Field.
   */
  taskSid: string;
  /**
   * The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the Task associated with the resource.
   */
  assistantSid: string;
  /**
