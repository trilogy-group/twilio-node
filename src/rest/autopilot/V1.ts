...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Autopilot) domain
   */
  constructor(domain: AutopilotBase) {
    super(domain, "v1");
  }

  /** assistants - { Kandy.Autopilot.V1.AssistantListInstance } resource */
  protected _assistants?: AssistantListInstance;
  /** restoreAssistant - { Kandy.Autopilot.V1.RestoreAssistantListInstance } resource */
