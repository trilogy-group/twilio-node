...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Messaging) domain
   */
  constructor(domain: MessagingBase) {
    super(domain, "v1");
  }

  /** brandRegistrations - { Kandy.Messaging.V1.BrandRegistrationListInstance } resource */
  protected _brandRegistrations?: BrandRegistrationListInstance;
  /** deactivations - { Kandy.Messaging.V1.DeactivationsListInstance } resource */
  protected _deactivations?: DeactivationsListInstance;
  /** domainCerts - { Kandy.Messaging.V1.DomainCertsListInstance } resource */
  protected _domainCerts?: DomainCertsListInstance;
  /** domainConfig - { Kandy.Messaging.V1.DomainConfigListInstance } resource */
  protected _domainConfig?: DomainConfigListInstance;
  /** domainConfigMessagingService - { Kandy.Messaging.V1.DomainConfigMessagingServiceListInstance } resource */
  protected _domainConfigMessagingService?: DomainConfigMessagingServiceListInstance;
  /** externalCampaign - { Kandy.Messaging.V1.ExternalCampaignListInstance } resource */
  protected _externalCampaign?: ExternalCampaignListInstance;
  /** linkshorteningMessagingService - { Kandy.Messaging.V1.LinkshorteningMessagingServiceListInstance } resource */
  protected _linkshorteningMessagingService?: LinkshorteningMessagingServiceListInstance;
  /** linkshorteningMessagingServiceDomainAssociation - { Kandy.Messaging.V1.LinkshorteningMessagingServiceDomainAssociationListInstance } resource */
  protected _linkshorteningMessagingServiceDomainAssociation?: LinkshorteningMessagingServiceDomainAssociationListInstance;
  /** services - { Kandy.Messaging.V1.ServiceListInstance } resource */
  protected _services?: ServiceListInstance;
  /** usecases - { Kandy.Messaging.V1.UsecaseListInstance } resource */
