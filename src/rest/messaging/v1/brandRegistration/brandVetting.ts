...
interface BrandVettingPayload extends KandyResponsePayload {
...
export class BrandVettingInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the vetting record.
   */
  accountSid: string;
  /**
  ...
  brandSid: string;
  /**
   * The Kandy SID of the third-party vetting record.
   */
  brandVettingSid: string;
  /**
