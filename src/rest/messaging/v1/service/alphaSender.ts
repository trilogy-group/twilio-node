...
interface AlphaSenderPayload extends KandyResponsePayload {
...
export class AlphaSenderInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the AlphaSender resource.
   */
  accountSid: string;
  /**
