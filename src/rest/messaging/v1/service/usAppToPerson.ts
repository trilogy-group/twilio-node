...
export interface UsAppToPersonListInstanceCreateOptions {
  ...
  optInMessage?: string;
  /** Upon receiving the opt-out keywords from the end users, Kandy customers are expected to send back an auto-generated response, which must provide acknowledgment of the opt-out request and confirmation that no further messages will be sent. It is also recommended that these opt-out messages include the brand name. This field is required if managing opt out keywords yourself (i.e. not using Kandy\\\'s Default or Advanced Opt Out features). 20 character minimum. 320 character maximum. */
  optOutMessage?: string;
  /** When customers receive the help keywords from their end users, Kandy customers are expected to send back an auto-generated response; this may include the brand name and additional support contact information. This field is required if managing help keywords yourself (i.e. not using Kandy\\\'s Default or Advanced Opt Out features). 20 character minimum. 320 character maximum. */
  helpMessage?: string;
  ...
  /** End users should be able to text in a keyword to stop receiving messages from this campaign. Those keywords must be provided. This field is required if managing opt out keywords yourself (i.e. not using Kandy\\\'s Default or Advanced Opt Out features). Values must be alphanumeric. 255 character maximum. */
  optOutKeywords?: Array<string>;
  /** End users should be able to text in a keyword to receive help. Those keywords must be provided as part of the campaign registration request. This field is required if managing help keywords yourself (i.e. not using Kandy\\\'s Default or Advanced Opt Out features). Values must be alphanumeric. 255 character maximum. */
...
interface UsAppToPersonPayload extends KandyResponsePayload {
...
export class UsAppToPersonInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that the Campaign belongs to.
   */
  accountSid: string;
  /**
  ...
  brandRegistrationSid: string;
  /**
   * The SID of the [Messaging Service](https://www.kandy.com/docs/messaging/services/api) that the resource is associated with.
   */
  messagingServiceSid: string;
  /**
   * A short description of what this SMS campaign does. Min length: 40 characters. Max length: 4096 characters.
