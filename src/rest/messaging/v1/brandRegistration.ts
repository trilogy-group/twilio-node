...
interface BrandRegistrationPayload extends KandyResponsePayload {
...
export class BrandRegistrationInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Brand Registration resource.
   */
  accountSid: string;
  /**
