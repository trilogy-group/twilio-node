...
export interface ByocTrunkContextUpdateOptions {
  ...
  /** Whether Caller ID Name (CNAM) lookup is enabled for the trunk. If enabled, all inbound calls to the BYOC Trunk from the United States and Canada automatically perform a CNAM Lookup and display Caller ID data on your phone. See [CNAM Lookups](https://www.kandy.com/docs/sip-trunking#CNAM) for more information. */
  cnamLookupEnabled?: boolean;
  /** The SID of the Connection Policy that Kandy will use when routing traffic to your communications infrastructure. */
  connectionPolicySid?: string;
  /** The SID of the SIP Domain that should be used in the `From` header of originating calls sent to your SIP infrastructure. If your SIP infrastructure allows users to \\\"call back\\\" an incoming call, configure this with a [SIP Domain](https://www.kandy.com/docs/voice/api/sending-sip) to ensure proper routing. If not configured, the from domain will default to \\\"sip.kandy.com\\\". */
...
interface ByocTrunkPayload extends KandyResponsePayload {
...
export class ByocTrunkInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the BYOC Trunk resource.
   */
  accountSid: string;
  /**
