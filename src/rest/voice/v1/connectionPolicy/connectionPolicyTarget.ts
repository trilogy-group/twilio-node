...
export interface ConnectionPolicyTargetContextUpdateOptions {
  ...
  friendlyName?: string;
  /** The SIP address you want Kandy to route your calls to. This must be a `sip:` schema. `sips` is NOT supported. */
  target?: string;
...
interface ConnectionPolicyTargetPayload extends KandyResponsePayload {
...
export class ConnectionPolicyTargetInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Target resource.
   */
  accountSid: string;
  /**
