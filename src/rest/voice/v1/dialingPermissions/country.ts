...
export interface CountryListInstanceEachOptions {
  ...
  /** Filter to retrieve the country permissions with dialing to high-risk [toll fraud](https://www.kandy.com/learn/voice-and-video/toll-fraud) numbers enabled. Can be: `true` or `false`. */
