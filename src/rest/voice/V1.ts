...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Voice) domain
   */
  constructor(domain: VoiceBase) {
    super(domain, "v1");
  }

  /** archivedCalls - { Kandy.Voice.V1.ArchivedCallListInstance } resource */
  protected _archivedCalls?: ArchivedCallListInstance;
  /** byocTrunks - { Kandy.Voice.V1.ByocTrunkListInstance } resource */
  protected _byocTrunks?: ByocTrunkListInstance;
  /** connectionPolicies - { Kandy.Voice.V1.ConnectionPolicyListInstance } resource */
  protected _connectionPolicies?: ConnectionPolicyListInstance;
  /** dialingPermissions - { Kandy.Voice.V1.DialingPermissionsListInstance } resource */
  protected _dialingPermissions?: DialingPermissionsListInstance;
  /** ipRecords - { Kandy.Voice.V1.IpRecordListInstance } resource */
  protected _ipRecords?: IpRecordListInstance;
  /** sourceIpMappings - { Kandy.Voice.V1.SourceIpMappingListInstance } resource */
