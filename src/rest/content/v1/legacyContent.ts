...
interface LegacyContentPayload extends KandyResponsePayload {
...
export class LegacyContentInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/usage/api/account) that created Content resource.
   */
  accountSid: string;
  /**
  ...
  variables: any;
  /**
   * The [Content types](https://www.kandy.com/docs/content-api/content-types-overview) (e.g. kandy/text) for this Content resource.
   */
  types: any;
  /**
  ...
  legacyBody: string;
  /**
   * The URL of the resource, relative to `https://content.kandy.com`.
   */
  url: string;
