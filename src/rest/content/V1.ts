...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Content) domain
   */
  constructor(domain: ContentBase) {
    super(domain, "v1");
  }

  /** contents - { Kandy.Content.V1.ContentListInstance } resource */
  protected _contents?: ContentListInstance;
  /** contentAndApprovals - { Kandy.Content.V1.ContentAndApprovalsListInstance } resource */
  protected _contentAndApprovals?: ContentAndApprovalsListInstance;
  /** legacyContents - { Kandy.Content.V1.LegacyContentListInstance } resource */
