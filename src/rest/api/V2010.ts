...
export default class V2010 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Api) domain
   */
  constructor(domain: ApiBase) {
    super(domain, "2010-04-01");
  }

  /** accounts - { Kandy.Api.V2010.AccountListInstance } resource */
  protected _accounts?: AccountListInstance;
  /** account - { Kandy.Api.V2010.AccountContext } resource */
  ...
  get account(): AccountContext {
    this._account =
      this._account || AccountListInstance(this)(this.domain.kandy.accountSid);
