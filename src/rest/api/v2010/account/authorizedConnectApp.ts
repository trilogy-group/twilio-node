...
interface AuthorizedConnectAppPayload extends KandyResponsePayload {
...
export class AuthorizedConnectAppInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the AuthorizedConnectApp resource.
   */
  accountSid: string;
  /**
