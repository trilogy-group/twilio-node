...
export interface NationalListInstanceEachOptions {
  ...
  areaCode?: number;
  /** The pattern on which to match phone numbers. Valid characters are `*`, `0-9`, `a-z`, and `A-Z`. The `*` character matches any single digit. For examples, see [Example 2](https://www.kandy.com/docs/phone-numbers/api/availablephonenumber-resource#local-get-basic-example-2) and [Example 3](https://www.kandy.com/docs/phone-numbers/api/availablephonenumber-resource#local-get-basic-example-3). If specified, this value must have at least two characters. */
  contains?: string;
  ...
  /** Whether to exclude phone numbers that require an [Address](https://www.kandy.com/docs/usage/api/address). Can be: `true` or `false` and the default is `false`. */
  excludeAllAddressRequired?: boolean;
  /** Whether to exclude phone numbers that require a local [Address](https://www.kandy.com/docs/usage/api/address). Can be: `true` or `false` and the default is `false`. */
  excludeLocalAddressRequired?: boolean;
  /** Whether to exclude phone numbers that require a foreign [Address](https://www.kandy.com/docs/usage/api/address). Can be: `true` or `false` and the default is `false`. */
  excludeForeignAddressRequired?: boolean;
  /** Whether to read phone numbers that are new to the Kandy platform. Can be: `true` or `false` and the default is `true`. */
  beta?: boolean;
...
interface NationalPayload extends KandyResponsePayload {
...
export class NationalPage extends Page<
  V2010,
  NationalPayload,
  NationalResource,
  NationalInstance
