...
export interface IncomingPhoneNumberContextUpdateOptions {
  /** The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IncomingPhoneNumber resource to update.  For more information, see [Exchanging Numbers Between Subaccounts](https://www.kandy.com/docs/iam/api/subaccounts#exchanging-numbers). */
  accountSid?: string;
...
export interface IncomingPhoneNumberListInstanceCreateOptions {
  ...
  /** The SID of the Bundle resource that you associate with the phone number. Some regions require a Bundle to meet local Regulations. */
  bundleSid?: string;
  /** The phone number to purchase specified in [E.164](https://www.kandy.com/docs/glossary/what-e164) format.  E.164 phone numbers consist of a + followed by the country code and subscriber number without punctuation characters. For example, +14155551234. */
  phoneNumber?: string;
...
export interface IncomingPhoneNumberListInstanceEachOptions {
  /** Whether to include phone numbers new to the Kandy platform. Can be: `true` or `false` and the default is `true`. */
  beta?: boolean;
  /** A string that identifies the IncomingPhoneNumber resources to read. */
  friendlyName?: string;
  /** The phone numbers of the IncomingPhoneNumber resources to read. You can specify partial numbers and use \'*\' as a wildcard for any digit. */
  phoneNumber?: string;
  /** Whether to include phone numbers based on their origin. Can be: `kandy` or `hosted`. By default, phone numbers of all origin are included. */
  origin?: string;
...
interface IncomingPhoneNumberPayload extends KandyResponsePayload {
...
export class IncomingPhoneNumberInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created this IncomingPhoneNumber resource.
   */
  accountSid: string;
  /**
  ...
  apiVersion: string;
  /**
   * Whether the phone number is new to the Kandy platform. Can be: `true` or `false`.
   */
  beta: boolean;
  capabilities: PhoneNumberCapabilities;
  /**
  ...
  phoneNumber: string;
  /**
   * The phone number\'s origin. `kandy` identifies Kandy-owned phone numbers and `hosted` identifies hosted phone numbers.
   */
  origin: string;
  /**
