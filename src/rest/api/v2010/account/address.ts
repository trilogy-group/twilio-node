...
interface AddressPayload extends KandyResponsePayload {
...
export class AddressInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that is responsible for the Address resource.
   */
  accountSid: string;
  /**
