...
export class TokenInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Token resource.
   */
  accountSid: string;
  /**
  ...
  /**
   * The temporary password that the username will use when authenticating with Kandy.
   */
  password: string;
  /**
