...
interface PayloadPayload extends KandyResponsePayload {
...
export class PayloadInstance {
  ...
  addOnResultSid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording AddOnResult Payload resource.
   */
  accountSid: string;
  /**
