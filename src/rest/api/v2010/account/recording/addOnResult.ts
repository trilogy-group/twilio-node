...
interface AddOnResultPayload extends KandyResponsePayload {
...
export class AddOnResultInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording AddOnResult resource.
   */
  accountSid: string;
  status: AddOnResultStatus;
  /**
