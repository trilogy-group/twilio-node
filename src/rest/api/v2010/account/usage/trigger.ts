...
export interface TriggerListInstanceEachOptions {
  ...
  recurring?: TriggerRecurring;
  /** The trigger field of the UsageTriggers to read.  Can be: `count`, `usage`, or `price` as described in the [UsageRecords documentation](https://www.kandy.com/docs/usage/api/usage-record#usage-count-price). */
  triggerBy?: TriggerTriggerField;
  /** The usage category of the UsageTriggers to read. Must be a supported [usage categories](https://www.kandy.com/docs/usage/api/usage-record#usage-categories). */
  usageCategory?: TriggerUsageCategory;
...
interface TriggerPayload extends KandyResponsePayload {
...
export class TriggerInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that the trigger monitors.
   */
  accountSid: string;
  /**
