...
export type YesterdayCategory =
  ...
  | "marketplace-kandy-caller-name-lookup-us"
  | "marketplace-kandy-carrier-information-lookup"
...
export interface YesterdayListInstanceEachOptions {
  /** The [usage category](https://www.kandy.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved. */
...
interface YesterdayPayload extends KandyResponsePayload {
...
export class YesterdayInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that accrued the usage.
   */
  accountSid: string;
  /**
  ...
  startDate: Date;
  /**
   * A list of related resources identified by their URIs. For more information, see [List Subresources](https://www.kandy.com/docs/usage/api/usage-record#list-subresources).
   */
...
export class YesterdayPage extends Page<
  V2010,
  YesterdayPayload,
  YesterdayResource,
  YesterdayInstance
