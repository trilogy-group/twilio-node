...
interface NotificationPayload extends KandyResponsePayload {
...
export class NotificationInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call Notification resource.
   */
  accountSid: string;
  /**
  ...
  apiVersion: string;
  /**
   * The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Call Notification resource is associated with.
   */
  callSid: string;
  /**
  ...
  dateUpdated: Date;
  /**
   * A unique error code for the error condition that is described in our [Error Dictionary](https://www.kandy.com/docs/api/errors).
   */
  errorCode: string;
  /**
  ...
  messageText: string;
  /**
   * The URL for more information about the error condition. This value is a page in our [Error Dictionary](https://www.kandy.com/docs/api/errors).
   */
  moreInfo: string;
  /**
