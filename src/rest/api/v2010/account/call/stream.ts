...
export class StreamInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created this Stream resource.
   */
  accountSid: string;
  /**
   * The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Stream resource is associated with.
   */
  callSid: string;
  /**
   * The user-specified name of this Stream, if one was given when the Stream was created. This may be used to stop the Stream.
  ...
  private get _proxy(): StreamContext {
    this._context =
      this._context ||
