...
export interface PaymentContextUpdateOptions {
  ...
  /** Provide an absolute or relative URL to receive status updates regarding your Pay session. Read more about the [Update](https://www.kandy.com/docs/voice/api/payment-resource#statuscallback-update) and [Complete/Cancel](https://www.kandy.com/docs/voice/api/payment-resource#statuscallback-cancelcomplete) POST requests. */
...
export interface PaymentListInstanceCreateOptions {
  /** A unique token that will be used to ensure that multiple API calls with the same information do not result in multiple transactions. This should be a unique string value per API call and can be a randomly generated. */
  idempotencyKey: string;
  /** Provide an absolute or relative URL to receive status updates regarding your Pay session. Read more about the [expected StatusCallback values](https://www.kandy.com/docs/voice/api/payment-resource#statuscallback) */
  statusCallback: string;
  /**  */
  ...
  /** A single-level JSON object used to pass custom parameters to payment processors. (Required for ACH payments). The information that has to be included here depends on the <Pay> Connector. [Read more](https://www.kandy.com/console/voice/pay-connectors). */
  parameter?: any;
  /** This is the unique name corresponding to the Pay Connector installed in the Kandy Add-ons. Learn more about [<Pay> Connectors](https://www.kandy.com/console/voice/pay-connectors). The default value is `Default`. */
...
export class PaymentInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Payments resource.
   */
  accountSid: string;
  /**
   * The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Payments resource is associated with. This will refer to the call sid that is producing the payment card (credit/ACH) information thru DTMF.
   */
  callSid: string;
  /**
