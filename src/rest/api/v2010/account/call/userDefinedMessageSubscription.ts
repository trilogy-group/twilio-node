...
export interface UserDefinedMessageSubscriptionListInstanceCreateOptions {
  ...
  /** The HTTP method Kandy will use when requesting the above `Url`. Either `GET` or `POST`. Default is `POST`. */
  method?: string;
}
...
export class UserDefinedMessageSubscriptionInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that subscribed to the User Defined Messages.
   */
  accountSid: string;
  /**
   * The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the User Defined Message Subscription is associated with. This refers to the Call SID that is producing the User Defined Messages.
   */
  callSid: string;
  /**
