...
export class UserDefinedMessageInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created User Defined Message.
   */
  accountSid: string;
  /**
   * The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the User Defined Message is associated with.
   */
  callSid: string;
  /**
