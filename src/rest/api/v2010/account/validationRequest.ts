...
export interface ValidationRequestListInstanceCreateOptions {
  /** The phone number to verify in [E.164](https://www.kandy.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number. */
  phoneNumber: string;
...
export class ValidationRequestInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for the Caller ID.
   */
  accountSid: string;
  /**
   * The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Caller ID is associated with.
   */
  callSid: string;
  /**
