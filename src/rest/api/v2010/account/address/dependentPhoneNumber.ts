...
interface DependentPhoneNumberPayload extends KandyResponsePayload {
...
export class DependentPhoneNumberInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the DependentPhoneNumber resource.
   */
  accountSid: string;
  /**
