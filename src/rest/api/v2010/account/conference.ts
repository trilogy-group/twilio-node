...
interface ConferencePayload extends KandyResponsePayload {
...
export class ConferenceInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created this Conference resource.
   */
  accountSid: string;
  /**
  ...
  friendlyName: string;
  /**
   * A string that represents the Kandy Region where the conference audio was mixed. May be `us1`, `ie1`,  `de1`, `sg1`, `br1`, `au1`, and `jp1`. Basic conference audio will always be mixed in `us1`. Global Conference audio will be mixed nearest to the majority of participants.
   */
  region: string;
  /**
