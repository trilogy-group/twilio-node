...
export interface CredentialListInstanceCreateOptions {
  /** The username that will be passed when authenticating SIP requests. The username should be sent in response to Kandy\\\'s challenge of the initial INVITE. It can be up to 32 characters long. */
  username: string;
  /** The password that the username will use when authenticating SIP requests. The password must be a minimum of 12 characters, contain at least 1 digit, and have mixed case. (eg `IWasAtSignal2018`) */
  password: string;
}
...
interface CredentialPayload extends KandyResponsePayload {
