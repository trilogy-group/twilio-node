...
export interface DomainContextUpdateOptions {
  ...
  /** The unique address you reserve on Kandy to which you route your SIP traffic. Domain names can contain letters, digits, and \\\"-\\\" and must end with `sip.kandy.com`. */
  domainName?: string;
...
interface DomainPayload extends KandyResponsePayload {
...
export class DomainInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the SipDomain resource.
   */
  accountSid: string;
  /**
