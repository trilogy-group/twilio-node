...
export interface IpAddressContextUpdateOptions {
  /** An IP address in dotted decimal notation from which you want to accept traffic. Any SIP requests from this IP address will be allowed by Kandy. IPv4 only supported today. */
  ipAddress?: string;
...
interface IpAddressPayload extends KandyResponsePayload {
