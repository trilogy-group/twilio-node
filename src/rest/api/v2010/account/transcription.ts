...
interface TranscriptionPayload extends KandyResponsePayload {
...
export class TranscriptionInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Transcription resource.
   */
  accountSid: string;
  /**
  ...
  priceUnit: string;
  /**
   * The SID of the [Recording](https://www.kandy.com/docs/voice/api/recording) from which the transcription was created.
   */
  recordingSid: string;
  /**
