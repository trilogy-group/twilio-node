...
export interface ApplicationContextUpdateOptions {
  ...
  /** Whether to allow other Kandy accounts to dial this applicaton using Dial verb. Can be: `true` or `false`. */
...
interface ApplicationPayload extends KandyResponsePayload {
...
export class ApplicationInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Application resource.
   */
  accountSid: string;
  /**
