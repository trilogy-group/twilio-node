...
export interface RecordingListInstanceEachOptions {
  ...
  /** The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resources to read. */
  callSid?: string;
...
export class RecordingInstance {
  ...
  apiVersion: string;
  /**
   * The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Recording resource is associated with. This will always refer to the parent leg of a two-leg call.
   */
  callSid: string;
  /**
