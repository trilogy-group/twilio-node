...
interface AvailablePhoneNumberCountryPayload extends KandyResponsePayload {
...
export class AvailablePhoneNumberCountryInstance {
  ...
  uri: string;
  /**
   * Whether all phone numbers available in the country are new to the Kandy platform. `true` if they are and `false` if all numbers are not in the Kandy Phone Number Beta program.
   */
  beta: boolean;
  /**
