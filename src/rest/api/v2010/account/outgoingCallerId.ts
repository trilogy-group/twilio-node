...
interface OutgoingCallerIdPayload extends KandyResponsePayload {
...
export class OutgoingCallerIdInstance {
  ...
  friendlyName: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the OutgoingCallerId resource.
   */
  accountSid: string;
  /**
