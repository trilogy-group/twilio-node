...
export class RecordingInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference Recording resource.
   */
  accountSid: string;
  /**
  ...
  apiVersion: string;
  /**
   * The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Conference Recording resource is associated with.
   */
  callSid: string;
  /**
