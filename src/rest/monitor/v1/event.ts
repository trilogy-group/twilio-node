...
export interface EventListInstanceEachOptions {
  ...
  actorSid?: string;
  /** Only include events of this [Event Type](https://www.kandy.com/docs/usage/monitor-events#event-types). */
  eventType?: string;
  /** Only include events that refer to this resource. Useful for discovering the history of a specific resource. */
  resourceSid?: string;
  /** Only include events that originated from this IP address. Useful for tracking suspicious activity originating from the API or the Kandy Console. */
...
interface EventPayload extends KandyResponsePayload {
...
export class EventInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Event resource.
   */
  accountSid: string;
  /**
  ...
  actorSid: string;
  /**
   * The type of actor that caused the event. Can be: `user` for a change made by a logged-in user in the Kandy Console, `account` for an event caused by an API request by an authenticating Account, `kandy-admin` for an event caused by a Kandy employee, and so on.
   */
  actorType: string;
  /**
  ...
  resourceSid: string;
  /**
   * The type of resource that was affected. For a full list of all resource-types, see the [Monitor Event Types](https://www.kandy.com/docs/usage/monitor-events#event-types).
   */
  resourceType: string;
  /**
  ...
  sid: string;
  /**
   * The originating system or interface that caused the event.  Can be: `web` for events caused by user action in the Kandy Console, `api` for events caused by a request to our API, or   `kandy` for events caused by an automated or internal Kandy system.
   */
  source: string;
  /**
   * The IP address of the source, if the source is outside the Kandy cloud. This value is `null` for events with `source` of `kandy`
   */
  sourceIpAddress: string;
  /**
