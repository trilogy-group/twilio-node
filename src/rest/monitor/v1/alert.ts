...
interface AlertPayload extends KandyResponsePayload {
...
export class AlertInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Alert resource.
   */
  accountSid: string;
  /**
  ...
  dateUpdated: Date;
  /**
   * The error code for the condition that generated the alert. See the [Error Dictionary](https://www.kandy.com/docs/api/errors) for possible causes and solutions to the error.
   */
  errorCode: string;
  /**
  ...
  logLevel: string;
  /**
   * The URL of the page in our [Error Dictionary](https://www.kandy.com/docs/api/errors) with more information about the error condition.
   */
  moreInfo: string;
  /**
