...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Pricing) domain
   */
  constructor(domain: PricingBase) {
    super(domain, "v1");
  }

  /** messaging - { Kandy.Pricing.V1.MessagingListInstance } resource */
  protected _messaging?: MessagingListInstance;
  /** phoneNumbers - { Kandy.Pricing.V1.PhoneNumberListInstance } resource */
  protected _phoneNumbers?: PhoneNumberListInstance;
  /** voice - { Kandy.Pricing.V1.VoiceListInstance } resource */
