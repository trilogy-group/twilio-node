...
export default class V2 extends Version {
  ...
  /** countries - { Kandy.Pricing.V2.CountryListInstance } resource */
  protected _countries?: CountryListInstance;
  /** numbers - { Kandy.Pricing.V2.NumberListInstance } resource */
  protected _numbers?: NumberListInstance;
  /** voice - { Kandy.Pricing.V2.VoiceListInstance } resource */
