...
/**
 * The [InboundCallPrice](https://www.kandy.com/docs/voice/pricing#inbound-call-price) record. If `null`, the Phone Number is not a Kandy number owned by this account.
 */
