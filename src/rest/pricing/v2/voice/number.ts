...
/**
 * The [InboundCallPrice](https://www.kandy.com/docs/voice/pricing#inbound-call-price) record.
 */
...
export interface NumberContextFetchOptions {
  /** The origination phone number, in [E.164](https://www.kandy.com/docs/glossary/what-e164) format, for which to fetch the origin-based voice pricing information. E.164 format consists of a + followed by the country code and subscriber number. */
...
export class NumberInstance {
  ...
  /**
   * The destination phone number in [E.164](https://www.kandy.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number.
   */
  destinationNumber: string;
  /**
   * The origination phone number in [[E.164](https://www.kandy.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number.
   */
  originationNumber: string;
  /**
  ...
  isoCountry: string;
  /**
   * The list of [OutboundCallPriceWithOrigin](https://www.kandy.com/docs/voice/pricing#outbound-call-price-with-origin) records.
   */
