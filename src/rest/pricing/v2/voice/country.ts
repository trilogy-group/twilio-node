...
export class CountryInstance {
  ...
  isoCountry: string;
  /**
   * The list of [OutboundPrefixPriceWithOrigin](https://www.kandy.com/docs/voice/pricing#outbound-prefix-price-with-origin) records.
   */
  outboundPrefixPrices: Array<PricingV2TrunkingCountryInstanceTerminatingPrefixPrices>;
  /**
   * The list of [InboundCallPrice](https://www.kandy.com/docs/voice/pricing#inbound-call-price) records.
   */
