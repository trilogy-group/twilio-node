...
export class CountryInstance {
  ...
  isoCountry: string;
  /**
   * The list of [TerminatingPrefixPrice](https://www.kandy.com/docs/voice/pricing#outbound-prefix-price-with-origin) records.
   */
  terminatingPrefixPrices: Array<PricingV2TrunkingCountryInstanceTerminatingPrefixPrices>;
  /**
   * The list of [OriginatingCallPrice](https://www.kandy.com/docs/voice/pricing#inbound-call-price) records.
   */
