...
export class UsageRecordInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the AccountUsageRecord resource.
   */
  accountSid: string;
  /**
  ...
  period: any;
  /**
   * An object that describes the aggregated Commands usage for all SIMs during the specified period. See [Commands Usage Object](https://www.kandy.com/docs/wireless/api/account-usagerecord-resource#commands-usage-object).
   */
  commands: any;
  /**
   * An object that describes the aggregated Data usage for all SIMs over the period. See [Data Usage Object](https://www.kandy.com/docs/wireless/api/account-usagerecord-resource#data-usage-object).
   */
  data: any;
