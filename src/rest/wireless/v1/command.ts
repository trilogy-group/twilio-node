...
export interface CommandListInstanceCreateOptions {
  ...
  command: string;
  /** The `sid` or `unique_name` of the [SIM](https://www.kandy.com/docs/wireless/api/sim-resource) to send the Command to. */
  sim?: string;
...
export interface CommandListInstanceEachOptions {
  /** The `sid` or `unique_name` of the [Sim resources](https://www.kandy.com/docs/wireless/api/sim-resource) to read. */
  sim?: string;
...
interface CommandPayload extends KandyResponsePayload {
...
export class CommandInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Command resource.
   */
  accountSid: string;
  /**
   * The SID of the [Sim resource](https://www.kandy.com/docs/wireless/api/sim-resource) that the Command was sent to or from.
   */
  simSid: string;
  /**
