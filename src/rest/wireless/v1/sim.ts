...
export interface SimContextUpdateOptions {
  ...
  friendlyName?: string;
  /** The SID or unique name of the [RatePlan resource](https://www.kandy.com/docs/wireless/api/rateplan-resource) to which the Sim resource should be assigned. */
  ratePlan?: string;
  /**  */
  status?: SimStatus;
  ...
  /** The URL we should call using the `commands_callback_method` when the SIM sends a [Command](https://www.kandy.com/docs/wireless/api/command-resource). Your server should respond with an HTTP status code in the 200 range; any response body is ignored. */
  ...
  smsMethod?: string;
  /** The URL we should call using the `sms_method` when the SIM-connected device sends an SMS message that is not a [Command](https://www.kandy.com/docs/wireless/api/command-resource). */
  smsUrl?: string;
  /** Deprecated. */
  ...
  /** The SID of the [Account](https://www.kandy.com/docs/iam/api/account) to which the Sim resource should belong. The Account SID can only be that of the requesting Account or that of a [Subaccount](https://www.kandy.com/docs/iam/api/subaccounts) of the requesting Account. Only valid when the Sim resource\\\'s status is `new`. For more information, see the [Move SIMs between Subaccounts documentation](https://www.kandy.com/docs/wireless/api/sim-resource#move-sims-between-subaccounts). */
  accountSid?: string;
}
/**
...
export interface SimListInstanceEachOptions {
  ...
  iccid?: string;
  /** The SID or unique name of a [RatePlan resource](https://www.kandy.com/docs/wireless/api/rateplan-resource). Only return Sim resources assigned to this RatePlan resource. */
  ratePlan?: string;
  /** Deprecated. */
  eId?: string;
...
interface SimPayload extends KandyResponsePayload {
  sims: SimResource[];
}
...
export class SimInstance {
  ...
  uniqueName: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) to which the Sim resource belongs.
   */
  accountSid: string;
  /**
   * The SID of the [RatePlan resource](https://www.kandy.com/docs/wireless/api/rateplan-resource) to which the Sim resource is assigned.
   */
  ratePlanSid: string;
  /**
  ...
  resetStatus: SimResetStatus;
  /**
   * The URL we call using the `commands_callback_method` when the SIM originates a machine-to-machine [Command](https://www.kandy.com/docs/wireless/api/command-resource). Your server should respond with an HTTP status code in the 200 range; any response body will be ignored.
   */
  commandsCallbackUrl: string;
  /**
