...
interface UsageRecordPayload extends KandyResponsePayload {
...
export class UsageRecordInstance {
  ...
  /**
   * The SID of the [Sim resource](https://www.kandy.com/docs/wireless/api/sim-resource) that this Usage Record is for.
   */
  simSid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the UsageRecord resource.
   */
  accountSid: string;
  /**
  ...
  period: any;
  /**
   * An object that describes the SIM\'s usage of Commands during the specified period. See [Commands Usage Object](https://www.kandy.com/docs/wireless/api/sim-usagerecord-resource#commands-usage-object).
   */
  commands: any;
  /**
   * An object that describes the SIM\'s data usage during the specified period. See [Data Usage Object](https://www.kandy.com/docs/wireless/api/sim-usagerecord-resource#data-usage-object).
   */
  data: any;
