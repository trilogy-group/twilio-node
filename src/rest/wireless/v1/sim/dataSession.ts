...
interface DataSessionPayload extends KandyResponsePayload {
...
export class DataSessionInstance {
  ...
  sid: string;
  /**
   * The SID of the [Sim resource](https://www.kandy.com/docs/wireless/api/sim-resource) that the Data Session is for.
   */
  simSid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the DataSession resource.
   */
  accountSid: string;
  /**
  ...
  /**
   * The friendly name of the mobile operator network that the [SIM](https://www.kandy.com/docs/wireless/api/sim-resource)-connected device is attached to. This is determined by looking up the `operator_mnc`.
   */
  operatorName: string;
  /**
