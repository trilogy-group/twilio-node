...
export interface RatePlanListInstanceCreateOptions {
  ...
  dataLimit?: number;
  /** The model used to meter data usage. Can be: `payg` and `quota-1`, `quota-10`, and `quota-50`. Learn more about the available [data metering models](https://www.kandy.com/docs/wireless/api/rateplan-resource#payg-vs-quota-data-plans). */
  dataMetering?: string;
  /** Whether SIMs can make, send, and receive SMS using [Commands](https://www.kandy.com/docs/wireless/api/command-resource). */
  messagingEnabled?: boolean;
  /** Deprecated. */
  voiceEnabled?: boolean;
  /** Whether SIMs can roam on networks other than the home network (T-Mobile USA) in the United States. See [national roaming](https://www.kandy.com/docs/wireless/api/rateplan-resource#national-roaming). */
...
interface RatePlanPayload extends KandyResponsePayload {
...
export class RatePlanInstance {
  ...
  uniqueName: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the RatePlan resource.
   */
  accountSid: string;
  /**
