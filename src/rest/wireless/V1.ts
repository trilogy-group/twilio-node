...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Wireless) domain
   */
  constructor(domain: WirelessBase) {
    super(domain, "v1");
  }

  /** commands - { Kandy.Wireless.V1.CommandListInstance } resource */
  protected _commands?: CommandListInstance;
  /** ratePlans - { Kandy.Wireless.V1.RatePlanListInstance } resource */
  protected _ratePlans?: RatePlanListInstance;
  /** sims - { Kandy.Wireless.V1.SimListInstance } resource */
  protected _sims?: SimListInstance;
  /** usageRecords - { Kandy.Wireless.V1.UsageRecordListInstance } resource */
