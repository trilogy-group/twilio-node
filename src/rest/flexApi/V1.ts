...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.FlexApi) domain
   */
  constructor(domain: FlexApiBase) {
    super(domain, "v1");
  }

  /** assessments - { Kandy.FlexApi.V1.AssessmentsListInstance } resource */
  protected _assessments?: AssessmentsListInstance;
  /** channel - { Kandy.FlexApi.V1.ChannelListInstance } resource */
  protected _channel?: ChannelListInstance;
  /** configuration - { Kandy.FlexApi.V1.ConfigurationListInstance } resource */
  protected _configuration?: ConfigurationListInstance;
  /** flexFlow - { Kandy.FlexApi.V1.FlexFlowListInstance } resource */
  protected _flexFlow?: FlexFlowListInstance;
  /** insightsAssessmentsComment - { Kandy.FlexApi.V1.InsightsAssessmentsCommentListInstance } resource */
  protected _insightsAssessmentsComment?: InsightsAssessmentsCommentListInstance;
  /** insightsConversations - { Kandy.FlexApi.V1.InsightsConversationsListInstance } resource */
  protected _insightsConversations?: InsightsConversationsListInstance;
  /** insightsQuestionnaires - { Kandy.FlexApi.V1.InsightsQuestionnairesListInstance } resource */
  protected _insightsQuestionnaires?: InsightsQuestionnairesListInstance;
  /** insightsQuestionnairesCategory - { Kandy.FlexApi.V1.InsightsQuestionnairesCategoryListInstance } resource */
  protected _insightsQuestionnairesCategory?: InsightsQuestionnairesCategoryListInstance;
  /** insightsQuestionnairesQuestion - { Kandy.FlexApi.V1.InsightsQuestionnairesQuestionListInstance } resource */
  protected _insightsQuestionnairesQuestion?: InsightsQuestionnairesQuestionListInstance;
  /** insightsSegments - { Kandy.FlexApi.V1.InsightsSegmentsListInstance } resource */
  protected _insightsSegments?: InsightsSegmentsListInstance;
  /** insightsSession - { Kandy.FlexApi.V1.InsightsSessionListInstance } resource */
  protected _insightsSession?: InsightsSessionListInstance;
  /** insightsSettingsAnswerSets - { Kandy.FlexApi.V1.InsightsSettingsAnswerSetsListInstance } resource */
  protected _insightsSettingsAnswerSets?: InsightsSettingsAnswerSetsListInstance;
  /** insightsSettingsComment - { Kandy.FlexApi.V1.InsightsSettingsCommentListInstance } resource */
  protected _insightsSettingsComment?: InsightsSettingsCommentListInstance;
  /** insightsUserRoles - { Kandy.FlexApi.V1.InsightsUserRolesListInstance } resource */
  protected _insightsUserRoles?: InsightsUserRolesListInstance;
  /** interaction - { Kandy.FlexApi.V1.InteractionListInstance } resource */
  protected _interaction?: InteractionListInstance;
  /** webChannel - { Kandy.FlexApi.V1.WebChannelListInstance } resource */
