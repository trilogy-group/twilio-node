...
export interface WebChannelsListInstanceCreateOptions {
  /** The SID of the Conversations Address. See [Address Configuration Resource](https://www.kandy.com/docs/conversations/api/address-configuration-resource) for configuration details. When a conversation is created on the Flex backend, the callback URL will be set to the corresponding Studio Flow SID or webhook URL in your address configuration. */
  addressSid: string;
  /** The Conversation\\\'s friendly name. See the [Conversation resource](https://www.kandy.com/docs/conversations/api/conversation-resource) for an example. */
  chatFriendlyName?: string;
  /** The Conversation participant\\\'s friendly name. See the [Conversation Participant Resource](https://www.kandy.com/docs/conversations/api/conversation-participant-resource) for an example. */
...
export class WebChannelsInstance {
  ...
  /**
   * The unique string representing the [Conversation resource](https://www.kandy.com/docs/conversations/api/conversation-resource) created.
   */
  conversationSid: string;
  /**
   * The unique string representing the User created and should be authorized to participate in the Conversation. For more details, see [User Identity & Access Tokens](https://www.kandy.com/docs/conversations/identity).
   */
  identity: string;
