...
interface WebChannelPayload extends KandyResponsePayload {
...
export class WebChannelInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the WebChannel resource and owns this Workflow.
   */
  accountSid: string;
  /**
   * The SID of the Flex Flow.
