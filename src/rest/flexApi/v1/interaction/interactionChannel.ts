...
interface InteractionChannelPayload extends KandyResponsePayload {
...
export class InteractionChannelInstance {
  ...
  /**
   * The unique string created by Kandy to identify an Interaction Channel resource, prefixed with UO.
   */
  sid: string;
  /**
  ...
  status: InteractionChannelChannelStatus;
  /**
   * The Kandy error code for a failed channel.
   */
  errorCode: number;
  /**
