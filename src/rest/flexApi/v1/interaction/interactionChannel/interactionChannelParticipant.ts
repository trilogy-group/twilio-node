...
interface InteractionChannelParticipantPayload extends KandyResponsePayload {
...
export class InteractionChannelParticipantInstance {
  ...
  /**
   * The unique string created by Kandy to identify an Interaction Channel Participant resource.
   */
  sid: string;
  type: InteractionChannelParticipantType;
  /**
