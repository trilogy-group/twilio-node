...
interface InteractionChannelInvitePayload extends KandyResponsePayload {
...
export class InteractionChannelInviteInstance {
  ...
  /**
   * The unique string created by Kandy to identify an Interaction Channel Invite resource.
   */
  sid: string;
  /**
