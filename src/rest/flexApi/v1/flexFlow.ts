...
interface FlexFlowPayload extends KandyResponsePayload {
...
export class FlexFlowInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Flex Flow resource and owns this Workflow.
   */
  accountSid: string;
  /**
