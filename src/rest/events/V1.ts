...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Events) domain
   */
  constructor(domain: EventsBase) {
    super(domain, "v1");
  }

  /** eventTypes - { Kandy.Events.V1.EventTypeListInstance } resource */
  protected _eventTypes?: EventTypeListInstance;
  /** schemas - { Kandy.Events.V1.SchemaListInstance } resource */
  protected _schemas?: SchemaListInstance;
  /** sinks - { Kandy.Events.V1.SinkListInstance } resource */
  protected _sinks?: SinkListInstance;
  /** subscriptions - { Kandy.Events.V1.SubscriptionListInstance } resource */
