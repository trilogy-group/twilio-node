...
export interface PhoneNumberListInstanceCreateOptions {
  /** The SID of the [Incoming Phone Number](https://www.kandy.com/docs/phone-numbers/api/incomingphonenumber-resource) that you want to associate with the trunk. */
