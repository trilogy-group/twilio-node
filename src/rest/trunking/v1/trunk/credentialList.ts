...
export interface CredentialListListInstanceCreateOptions {
  /** The SID of the [Credential List](https://www.kandy.com/docs/voice/sip/api/sip-credentiallist-resource) that you want to associate with the trunk. Once associated, we will authenticate access to the trunk against this list. */
...
interface CredentialListPayload extends KandyResponsePayload {
...
export class CredentialListInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the CredentialList resource.
   */
  accountSid: string;
  /**
