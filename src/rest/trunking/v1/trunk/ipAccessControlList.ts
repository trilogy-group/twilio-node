...
export interface IpAccessControlListListInstanceCreateOptions {
  /** The SID of the [IP Access Control List](https://www.kandy.com/docs/voice/sip/api/sip-ipaccesscontrollist-resource) that you want to associate with the trunk. */
...
interface IpAccessControlListPayload extends KandyResponsePayload {
...
export class IpAccessControlListInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IpAccessControlList resource.
   */
  accountSid: string;
  /**
