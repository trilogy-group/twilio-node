...
export interface OriginationUrlContextUpdateOptions {
  ...
  friendlyName?: string;
  /** The SIP address you want Kandy to route your Origination calls to. This must be a `sip:` schema. `sips` is NOT supported. */
  sipUrl?: string;
}
...
export interface OriginationUrlListInstanceCreateOptions {
  ...
  /** A descriptive string that you create to describe the resource. It can be up to 64 characters long. */
  friendlyName: string;
  /** The SIP address you want Kandy to route your Origination calls to. This must be a `sip:` schema. */
  sipUrl: string;
}
/**
...
interface OriginationUrlPayload extends KandyResponsePayload {
...
export class OriginationUrlInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the OriginationUrl resource.
   */
  accountSid: string;
  /**
