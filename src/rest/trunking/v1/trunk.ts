...
export interface TrunkContextUpdateOptions {
  ...
  friendlyName?: string;
  /** The unique address you reserve on Kandy to which you route your SIP traffic. Domain names can contain letters, digits, and `-` and must end with `pstn.kandy.com`. See [Termination Settings](https://www.kandy.com/docs/sip-trunking#termination) for more information. */
  domainName?: string;
  /** The URL we should call using the `disaster_recovery_method` if an error occurs while sending SIP traffic towards the configured Origination URL. We retrieve TwiML from the URL and execute the instructions like any other normal TwiML call. See [Disaster Recovery](https://www.kandy.com/docs/sip-trunking#disaster-recovery) for more information. */
  ...
  /** Whether Secure Trunking is enabled for the trunk. If enabled, all calls going through the trunk will be secure using SRTP for media and TLS for signaling. If disabled, then RTP will be used for media. See [Secure Trunking](https://www.kandy.com/docs/sip-trunking#securetrunking) for more information. */
  secure?: boolean;
  /** Whether Caller ID Name (CNAM) lookup should be enabled for the trunk. If enabled, all inbound calls to the SIP Trunk from the United States and Canada automatically perform a CNAM Lookup and display Caller ID data on your phone. See [CNAM Lookups](https://www.kandy.com/docs/sip-trunking#CNAM) for more information. */
...
interface TrunkPayload extends KandyResponsePayload {
...
export class TrunkInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Trunk resource.
   */
  accountSid: string;
  /**
   * The unique address you reserve on Kandy to which you route your SIP traffic. Domain names can contain letters, digits, and `-` and must end with `pstn.kandy.com`. See [Termination Settings](https://www.kandy.com/docs/sip-trunking#termination) for more information.
  ...
  disasterRecoveryMethod: string;
  /**
   * The URL we call using the `disaster_recovery_method` if an error occurs while sending SIP traffic towards the configured Origination URL. We retrieve TwiML from this URL and execute the instructions like any other normal TwiML call. See [Disaster Recovery](https://www.kandy.com/docs/sip-trunking#disaster-recovery) for more information.
   */
  disasterRecoveryUrl: string;
  /**
