...
export default class V1 extends Version {
   ...
   *
   * @param domain - The Kandy (Kandy.Trusthub) domain
   */
  constructor(domain: TrusthubBase) {
    super(domain, "v1");
  }

  /** customerProfiles - { Kandy.Trusthub.V1.CustomerProfilesListInstance } resource */
  protected _customerProfiles?: CustomerProfilesListInstance;
  /** endUsers - { Kandy.Trusthub.V1.EndUserListInstance } resource */
  protected _endUsers?: EndUserListInstance;
  /** endUserTypes - { Kandy.Trusthub.V1.EndUserTypeListInstance } resource */
  protected _endUserTypes?: EndUserTypeListInstance;
  /** policies - { Kandy.Trusthub.V1.PoliciesListInstance } resource */
  protected _policies?: PoliciesListInstance;
  /** supportingDocuments - { Kandy.Trusthub.V1.SupportingDocumentListInstance } resource */
  protected _supportingDocuments?: SupportingDocumentListInstance;
  /** supportingDocumentTypes - { Kandy.Trusthub.V1.SupportingDocumentTypeListInstance } resource */
  protected _supportingDocumentTypes?: SupportingDocumentTypeListInstance;
  /** trustProducts - { Kandy.Trusthub.V1.TrustProductsListInstance } resource */
