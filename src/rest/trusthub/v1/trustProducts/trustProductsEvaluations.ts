...
interface TrustProductsEvaluationsPayload extends KandyResponsePayload {
...
export class TrustProductsEvaluationsInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the trust_product resource.
   */
  accountSid: string;
  /**
