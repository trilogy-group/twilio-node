...
interface TrustProductsEntityAssignmentsPayload extends KandyResponsePayload {
...
export class TrustProductsEntityAssignmentsInstance {
  ...
  trustProductSid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Item Assignment resource.
   */
  accountSid: string;
  /**
   * The SID of an object bag that holds information of the different items.
