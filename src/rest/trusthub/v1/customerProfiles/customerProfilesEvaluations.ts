...
interface CustomerProfilesEvaluationsPayload extends KandyResponsePayload {
...
export class CustomerProfilesEvaluationsInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the customer_profile resource.
   */
  accountSid: string;
  /**
   * The unique string of a policy that is associated to the customer_profile resource.
