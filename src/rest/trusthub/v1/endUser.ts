...
interface EndUserPayload extends KandyResponsePayload {
...
export class EndUserInstance {
  ...
  /**
   * The unique string created by Kandy to identify the End User resource.
   */
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the End User resource.
   */
  accountSid: string;
  /**
   * The string that you assigned to describe the resource.
