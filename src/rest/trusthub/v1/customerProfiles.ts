...
interface CustomerProfilesPayload extends KandyResponsePayload {
...
export class CustomerProfilesInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Customer-Profile resource.
   */
  accountSid: string;
  /**
   * The unique string of a policy that is associated to the Customer-Profile resource.
