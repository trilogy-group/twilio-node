...
interface InstalledAddOnPayload extends KandyResponsePayload {
...
export class InstalledAddOnInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the InstalledAddOn resource.
   */
  accountSid: string;
  /**
