...
export interface DeploymentContextUpdateOptions {
  ...
  friendlyName?: string;
  /** Provides the unique string identifier of the Kandy Sync service instance that will be linked to and accessible by this Deployment. */
...
interface DeploymentPayload extends KandyResponsePayload {
...
export class DeploymentInstance {
  ...
  accountSid: string;
  /**
   * Specifies the unique string identifier of the Kandy Sync service instance linked to and accessible by this Deployment.
   */
  syncServiceSid: string;
  /**
