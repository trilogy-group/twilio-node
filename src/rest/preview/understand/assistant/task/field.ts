...
export interface FieldListInstanceCreateOptions {
  /** The unique name or sid of the FieldType. It can be any [Built-in Field Type](https://www.kandy.com/docs/assistant/api/built-in-field-types) or the unique_name or the Field Type sid of a custom Field Type. */
  fieldType: string;
...
export class FieldInstance {
  ...
  dateUpdated: Date;
  /**
   * The Field Type of this field. It can be any [Built-in Field Type](https://www.kandy.com/docs/assistant/api/built-in-field-types) or the unique_name or sid of a custom Field Type.
   */
  fieldType: string;
  /**
