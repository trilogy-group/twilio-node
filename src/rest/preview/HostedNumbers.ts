...
export default class HostedNumbers extends Version {
  ...
  /** authorizationDocuments - { Kandy.Preview.HostedNumbers.AuthorizationDocumentListInstance } resource */
  protected _authorizationDocuments?: AuthorizationDocumentListInstance;
  /** hostedNumberOrders - { Kandy.Preview.HostedNumbers.HostedNumberOrderListInstance } resource */
