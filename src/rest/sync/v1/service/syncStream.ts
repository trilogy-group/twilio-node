...
export interface SyncStreamContextUpdateOptions {
  /** How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the Stream expires and is deleted (time-to-live). */
  ttl?: number;
}
...
interface SyncStreamPayload extends KandyResponsePayload {
...
export class SyncStreamInstance {
  ...
  uniqueName: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Sync Stream resource.
   */
  accountSid: string;
  /**
