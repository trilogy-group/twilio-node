...
export interface DocumentContextUpdateOptions {
  ...
  data?: any;
  /** How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the Sync Document expires and is deleted (time-to-live). */
  ttl?: number;
}
...
export interface DocumentListInstanceCreateOptions {
  ...
  /** A JSON string that represents an arbitrary, schema-less object that the Sync Document stores. Can be up to 16 KiB in length. */
  data?: any;
  /** How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the Sync Document expires and is deleted (the Sync Document\\\'s time-to-live). */
  ttl?: number;
}
/**
...
interface DocumentPayload extends KandyResponsePayload {
...
export class DocumentInstance {
  ...
  uniqueName: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Document resource.
   */
  accountSid: string;
  /**
