...
interface SyncMapPermissionPayload extends KandyResponsePayload {
...
export class SyncMapPermissionInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Sync Map Permission resource.
   */
  accountSid: string;
  /**
