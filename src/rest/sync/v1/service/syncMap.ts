...
export interface SyncMapContextUpdateOptions {
  ...
  ttl?: number;
  /** How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the Sync Map expires (time-to-live) and is deleted. */
...
interface SyncMapPayload extends KandyResponsePayload {
...
export class SyncMapInstance {
  ...
  uniqueName: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Sync Map resource.
   */
  accountSid: string;
  /**
