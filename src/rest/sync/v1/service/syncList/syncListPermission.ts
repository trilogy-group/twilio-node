...
interface SyncListPermissionPayload extends KandyResponsePayload {
...
export class SyncListPermissionInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Sync List Permission resource.
   */
  accountSid: string;
  /**
