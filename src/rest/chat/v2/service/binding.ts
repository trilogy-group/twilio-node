...
export interface BindingListInstanceEachOptions {
  /** The push technology used by the Binding resources to read.  Can be: `apn`, `gcm`, or `fcm`.  See [push notification configuration](https://www.kandy.com/docs/chat/push-notification-configuration) for more info. */
  bindingType?: Array<BindingBindingType>;
  /** The [User](https://www.kandy.com/docs/chat/rest/user-resource)\'s `identity` value of the resources to read. See [access tokens](https://www.kandy.com/docs/chat/create-tokens) for more details. */
...
export class BindingInstance {
  ...
  accountSid: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the Binding resource is associated with.
   */
  serviceSid: string;
  /**
  ...
  identity: string;
  /**
   * The SID of the [Credential](https://www.kandy.com/docs/chat/rest/credential-resource) for the binding. See [push notification configuration](https://www.kandy.com/docs/chat/push-notification-configuration) for more info.
   */
  credentialSid: string;
  bindingType: BindingBindingType;
  /**
   * The [Programmable Chat message types](https://www.kandy.com/docs/chat/push-notification-configuration#push-types) the binding is subscribed to.
   */
  ...
  url: string;
  /**
   * The absolute URLs of the Binding\'s [User](https://www.kandy.com/docs/chat/rest/user-resource).
   */
  links: Record<string, string>;
