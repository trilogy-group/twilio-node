...
export interface MemberContextRemoveOptions {
  ...
  xKandyWebhookEnabled?: MemberWebhookEnabledType;
}
...
export interface MemberContextUpdateOptions {
  /** The X-Kandy-Webhook-Enabled HTTP request header */
  xKandyWebhookEnabled?: MemberWebhookEnabledType;
  /** The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) to assign to the member. The default roles are those specified on the [Service](https://www.kandy.com/docs/chat/rest/service-resource). */
  roleSid?: string;
  /** The index of the last [Message](https://www.kandy.com/docs/chat/rest/message-resource) that the Member has read within the [Channel](https://www.kandy.com/docs/chat/channels). */
  lastConsumedMessageIndex?: number;
  /** The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) timestamp of the last [Message](https://www.kandy.com/docs/chat/rest/message-resource) read event for the Member within the [Channel](https://www.kandy.com/docs/chat/channels). */
...
export interface MemberListInstanceCreateOptions {
  /** The `identity` value that uniquely identifies the new resource\\\'s [User](https://www.kandy.com/docs/chat/rest/user-resource) within the [Service](https://www.kandy.com/docs/chat/rest/service-resource). See [access tokens](https://www.kandy.com/docs/chat/create-tokens) for more info. */
  identity: string;
  /** The X-Kandy-Webhook-Enabled HTTP request header */
  xKandyWebhookEnabled?: MemberWebhookEnabledType;
  /** The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) to assign to the member. The default roles are those specified on the [Service](https://www.kandy.com/docs/chat/rest/service-resource). */
  roleSid?: string;
  /** The index of the last [Message](https://www.kandy.com/docs/chat/rest/message-resource) in the [Channel](https://www.kandy.com/docs/chat/channels) that the Member has read. This parameter should only be used when recreating a Member from a backup/separate source. */
  lastConsumedMessageIndex?: number;
  /** The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) timestamp of the last [Message](https://www.kandy.com/docs/chat/rest/message-resource) read event for the Member within the [Channel](https://www.kandy.com/docs/chat/channels). */
  lastConsumptionTimestamp?: Date;
  /** The date, specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format, to assign to the resource as the date it was created. The default value is the current time set by the Chat service.  Note that this parameter should only be used when a Member is being recreated from a backup/separate source. */
...
export interface MemberListInstanceEachOptions {
  /** The [User](https://www.kandy.com/docs/chat/rest/user-resource)\'s `identity` value of the Member resources to read. See [access tokens](https://www.kandy.com/docs/chat/create-tokens) for more details. */
...
export class MemberInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Member resource.
   */
  accountSid: string;
  /**
   * The SID of the [Channel](https://www.kandy.com/docs/chat/channels) the Member resource belongs to.
   */
  channelSid: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the Member resource is associated with.
   */
  serviceSid: string;
  /**
   * The application-defined string that uniquely identifies the resource\'s [User](https://www.kandy.com/docs/chat/rest/user-resource) within the [Service](https://www.kandy.com/docs/chat/rest/service-resource). See [access tokens](https://www.kandy.com/docs/chat/create-tokens) for more info.
   */
  identity: string;
  /**
  ...
  dateUpdated: Date;
  /**
   * The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) assigned to the member.
   */
  roleSid: string;
  /**
   * The index of the last [Message](https://www.kandy.com/docs/chat/rest/message-resource) in the [Channel](https://www.kandy.com/docs/chat/channels) that the Member has read.
   */
  lastConsumedMessageIndex: number;
  /**
   * The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) timestamp of the last [Message](https://www.kandy.com/docs/chat/rest/message-resource) read event for the Member within the [Channel](https://www.kandy.com/docs/chat/channels).
