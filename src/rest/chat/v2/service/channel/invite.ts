...
export interface InviteListInstanceCreateOptions {
  ...
  identity: string;
  /** The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) assigned to the new member. */
  roleSid?: string;
}
/**
...
export class InviteInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Invite resource.
   */
  accountSid: string;
  /**
   * The SID of the [Channel](https://www.kandy.com/docs/chat/channels) the Invite resource belongs to.
   */
  channelSid: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the Invite resource is associated with.
   */
  serviceSid: string;
  /**
  ...
  dateUpdated: Date;
  /**
   * The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) assigned to the resource.
   */
  roleSid: string;
  /**
