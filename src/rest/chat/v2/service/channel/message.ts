...
export interface MessageContextRemoveOptions {
  ...
  xKandyWebhookEnabled?: MessageWebhookEnabledType;
}
...
export interface MessageContextUpdateOptions {
  ...
  dateUpdated?: Date;
  /** The [Identity](https://www.kandy.com/docs/chat/identity) of the User who last updated the Message, if applicable. */
  lastUpdatedBy?: string;
  /** The [Identity](https://www.kandy.com/docs/chat/identity) of the message\\\'s author. */
  from?: string;
}
...
export interface MessageListInstanceCreateOptions {
  /** The X-Kandy-Webhook-Enabled HTTP request header */
  xKandyWebhookEnabled?: MessageWebhookEnabledType;
  /** The [Identity](https://www.kandy.com/docs/chat/identity) of the new message\\\'s author. The default value is `system`. */
  from?: string;
  /** A valid JSON string that contains application-specific data. */
  attributes?: string;
  /** The date, specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format, to assign to the resource as the date it was created. The default value is the current time set by the Chat service. This parameter should only be used when a Chat\\\'s history is being recreated from a backup/separate source. */
  ...
  /** The message to send to the channel. Can be an empty string or `null`, which sets the value as an empty string. You can send structured data in the body by serializing it as a string. */
  body?: string;
  /** The SID of the [Media](https://www.kandy.com/docs/chat/rest/media) to attach to the new Message. */
  mediaSid?: string;
}
/**
...
export class MessageInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Message resource.
   */
  accountSid: string;
  /**
  ...
  attributes: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the Message resource is associated with.
   */
  serviceSid: string;
  /**
   * The SID of the [Channel](https://www.kandy.com/docs/chat/channels) that the message was sent to.
   */
  to: string;
  /**
   * The SID of the [Channel](https://www.kandy.com/docs/chat/channels) the Message resource belongs to.
   */
  channelSid: string;
  /**
  ...
  wasEdited: boolean;
  /**
   * The [Identity](https://www.kandy.com/docs/chat/identity) of the message\'s author. The default value is `system`.
   */
  from: string;
  /**
  ...
  body: string;
  /**
   * The index of the message within the [Channel](https://www.kandy.com/docs/chat/channels). Indices may skip numbers, but will always be in order of when the message was received.
   */
  index: number;
  /**
