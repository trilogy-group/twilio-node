...
export interface UserContextUpdateOptions {
  ...
  /** The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) to assign to the User. */
  roleSid?: string;
...
export interface UserListInstanceCreateOptions {
  /** The `identity` value that uniquely identifies the new resource\\\'s [User](https://www.kandy.com/docs/chat/rest/user-resource) within the [Service](https://www.kandy.com/docs/chat/rest/service-resource). This value is often a username or email address. See the Identity documentation for more info. */
  identity: string;
  /** The X-Kandy-Webhook-Enabled HTTP request header */
  xKandyWebhookEnabled?: UserWebhookEnabledType;
  /** The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) to assign to the new User. */
  roleSid?: string;
  /** A valid JSON string that contains application-specific data. */
  attributes?: string;
...
export class UserInstance {
  ...
  accountSid: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the User resource is associated with.
   */
  serviceSid: string;
  /**
  ...
  friendlyName: string;
  /**
   * The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) assigned to the user.
   */
  roleSid: string;
  /**
   * The application-defined string that uniquely identifies the resource\'s User within the [Service](https://www.kandy.com/docs/chat/rest/service-resource). This value is often a username or an email address, and is case-sensitive. See [access tokens](https://www.kandy.com/docs/chat/create-tokens) for more info.
   */
  identity: string;
  /**
  ...
  /**
   * The absolute URLs of the [Channel](https://www.kandy.com/docs/chat/channels) and [Binding](https://www.kandy.com/docs/chat/rest/binding-resource) resources related to the user.
   */
  links: Record<string, string>;
  /**
