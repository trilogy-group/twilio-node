...
export interface ChannelContextRemoveOptions {
  ...
  xKandyWebhookEnabled?: ChannelWebhookEnabledType;
}
...
interface ChannelPayload extends KandyResponsePayload {
...
export class ChannelInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Channel resource.
   */
  accountSid: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the Channel resource is associated with.
   */
  serviceSid: string;
  /**
