...
export interface UserBindingListInstanceEachOptions {
  /** The push technology used by the User Binding resources to read. Can be: `apn`, `gcm`, or `fcm`.  See [push notification configuration](https://www.kandy.com/docs/chat/push-notification-configuration) for more info. */
...
interface UserBindingPayload extends KandyResponsePayload {
...
export class UserBindingInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the User Binding resource.
   */
  accountSid: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the User Binding resource is associated with.
   */
  serviceSid: string;
  /**
  ...
  identity: string;
  /**
   * The SID of the [User](https://www.kandy.com/docs/chat/rest/user-resource) with the User Binding resource.  See [push notification configuration](https://www.kandy.com/docs/chat/push-notification-configuration) for more info.
   */
  userSid: string;
  /**
