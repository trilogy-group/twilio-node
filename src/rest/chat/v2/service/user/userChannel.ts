...
export interface UserChannelContextRemoveOptions {
  ...
  xKandyWebhookEnabled?: UserChannelWebhookEnabledType;
}
...
interface UserChannelPayload extends KandyResponsePayload {
...
export class UserChannelInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the User Channel resource.
   */
  accountSid: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the User Channel resource is associated with.
   */
  serviceSid: string;
  /**
   * The SID of the [Channel](https://www.kandy.com/docs/chat/channels) the User Channel resource belongs to.
   */
  channelSid: string;
  /**
   * The SID of the [User](https://www.kandy.com/docs/chat/rest/user-resource) the User Channel belongs to.
   */
  userSid: string;
  /**
   * The SID of a [Member](https://www.kandy.com/docs/chat/rest/member-resource) that represents the User on the Channel.
   */
  memberSid: string;
  status: UserChannelChannelStatus;
  /**
  ...
  lastConsumedMessageIndex: number;
  /**
   * The number of unread Messages in the Channel for the User. Note that retrieving messages on a client endpoint does not mean that messages are consumed or read. See [Consumption Horizon feature](https://www.kandy.com/docs/chat/consumption-horizon) to learn how to mark messages as consumed.
   */
  unreadMessagesCount: number;
  /**
   * The absolute URLs of the [Members](https://www.kandy.com/docs/chat/rest/member-resource), [Messages](https://www.kandy.com/docs/chat/rest/message-resource) , [Invites](https://www.kandy.com/docs/chat/rest/invite-resource) and, if it exists, the last [Message](https://www.kandy.com/docs/chat/rest/message-resource) for the Channel.
   */
  links: Record<string, string>;
  /**
