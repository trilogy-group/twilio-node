...
export interface ServiceContextUpdateOptions {
  ...
  friendlyName?: string;
  /** The service role assigned to users when they are added to the service. See the [Roles endpoint](https://www.kandy.com/docs/chat/api/roles) for more details. */
  defaultServiceRoleSid?: string;
  /** The channel role assigned to users when they are added to a channel. See the [Roles endpoint](https://www.kandy.com/docs/chat/api/roles) for more details. */
  defaultChannelRoleSid?: string;
  /** The channel role assigned to a channel creator when they join a new channel. See the [Roles endpoint](https://www.kandy.com/docs/chat/api/roles) for more details. */
  ...
  /** The URL for pre-event webhooks, which are called by using the `webhook_method`. See [Webhook Events](https://www.kandy.com/docs/api/chat/webhooks) for more details. */
  preWebhookUrl?: string;
  /** The URL for post-event webhooks, which are called by using the `webhook_method`. See [Webhook Events](https://www.kandy.com/docs/api/chat/webhooks) for more details. */
...
export class ServiceInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/api/rest/account) that created the Service resource.
   */
  accountSid: string;
  /**
  ...
  webhookFilters: Array<string>;
  /**
   * The notification configuration for the Service instance. See [Push Notification Configuration](https://www.kandy.com/docs/chat/push-notification-configuration) for more information.
   */
  notifications: any;
  /**
  ...
  url: string;
  /**
   * The absolute URLs of the Service\'s [Channels](https://www.kandy.com/docs/chat/api/channels), [Roles](https://www.kandy.com/docs/chat/api/roles), and [Users](https://www.kandy.com/docs/chat/api/users).
   */
  links: Record<string, string>;
