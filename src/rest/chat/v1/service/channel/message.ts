...
export interface MessageListInstanceCreateOptions {
  /** The message to send to the channel. Can also be an empty string or `null`, which sets the value as an empty string. You can send structured data in the body by serializing it as a string. */
  body: string;
  /** The [identity](https://www.kandy.com/docs/api/chat/guides/identity) of the new message\\\'s author. The default value is `system`. */
  from?: string;
  /** A valid JSON string that contains application-specific data. */
  attributes?: string;
}
...
export class MessageInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/api/rest/account) that created the Message resource.
   */
  accountSid: string;
  /**
  ...
  serviceSid: string;
  /**
   * The SID of the [Channel](https://www.kandy.com/docs/chat/api/channels) that the message was sent to.
   */
  to: string;
  /**
   * The unique ID of the [Channel](https://www.kandy.com/docs/api/chat/rest/channels) the Message resource belongs to.
   */
  channelSid: string;
  /**
  ...
  wasEdited: boolean;
  /**
   * The [identity](https://www.kandy.com/docs/api/chat/guides/identity) of the message\'s author. The default value is `system`.
   */
  from: string;
  /**
  ...
  body: string;
  /**
   * The index of the message within the [Channel](https://www.kandy.com/docs/chat/api/channels).
   */
  index: number;
  /**
