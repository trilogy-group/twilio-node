...
export interface MemberContextUpdateOptions {
  /** The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) to assign to the member. The default roles are those specified on the [Service](https://www.kandy.com/docs/chat/api/services). */
  roleSid?: string;
  /** The index of the last [Message](https://www.kandy.com/docs/api/chat/rest/messages) that the Member has read within the [Channel](https://www.kandy.com/docs/api/chat/rest/channels). */
...
export interface MemberListInstanceCreateOptions {
  /** The `identity` value that uniquely identifies the new resource\\\'s [User](https://www.kandy.com/docs/api/chat/rest/v1/user) within the [Service](https://www.kandy.com/docs/api/chat/rest/services). See [access tokens](https://www.kandy.com/docs/api/chat/guides/create-tokens) for more details. */
  identity: string;
  /** The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) to assign to the member. The default roles are those specified on the [Service](https://www.kandy.com/docs/chat/api/services). */
  roleSid?: string;
}
...
export interface MemberListInstanceEachOptions {
  /** The [User](https://www.kandy.com/docs/api/chat/rest/v1/user)\'s `identity` value of the resources to read. See [access tokens](https://www.kandy.com/docs/api/chat/guides/create-tokens) for more details. */
...
export class MemberInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/api/rest/account) that created the Member resource.
   */
  accountSid: string;
  /**
   * The unique ID of the [Channel](https://www.kandy.com/docs/api/chat/rest/channels) for the member.
   */
  channelSid: string;
  /**
   * The SID of the [Service](https://www.kandy.com/docs/api/chat/rest/services) the resource is associated with.
   */
  serviceSid: string;
  /**
   * The application-defined string that uniquely identifies the resource\'s [User](https://www.kandy.com/docs/api/chat/rest/users) within the [Service](https://www.kandy.com/docs/api/chat/rest/services). See [access tokens](https://www.kandy.com/docs/api/chat/guides/create-tokens) for more info.
   */
  identity: string;
  /**
  ...
  dateUpdated: Date;
  /**
   * The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) assigned to the member.
   */
  roleSid: string;
  /**
   * The index of the last [Message](https://www.kandy.com/docs/api/chat/rest/messages) in the [Channel](https://www.kandy.com/docs/api/chat/rest/channels) that the Member has read.
   */
  lastConsumedMessageIndex: number;
  /**
   * The ISO 8601 timestamp string that represents the date-time of the last [Message](https://www.kandy.com/docs/api/chat/rest/messages) read event for the Member within the [Channel](https://www.kandy.com/docs/api/chat/rest/channels).
   */
