...
export interface InviteListInstanceCreateOptions {
  /** The `identity` value that uniquely identifies the new resource\\\'s [User](https://www.kandy.com/docs/api/chat/rest/v1/user) within the [Service](https://www.kandy.com/docs/api/chat/rest/v1/service). See [access tokens](https://www.kandy.com/docs/api/chat/guides/create-tokens) for more info. */
  identity: string;
  /** The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) assigned to the new member. */
  roleSid?: string;
}
/**
...
interface InvitePayload extends KandyResponsePayload {
...
export class InviteInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/api/rest/account) that created the Invite resource.
   */
  accountSid: string;
  /**
   * The SID of the [Channel](https://www.kandy.com/docs/api/chat/rest/channels) the resource belongs to.
   */
  channelSid: string;
  /**
  ...
  dateUpdated: Date;
  /**
   * The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) assigned to the resource.
   */
  roleSid: string;
  /**
