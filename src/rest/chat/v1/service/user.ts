...
export interface UserContextUpdateOptions {
  /** The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) assigned to this user. */
  roleSid?: string;
...
export interface UserListInstanceCreateOptions {
  /** The `identity` value that uniquely identifies the new resource\\\'s [User](https://www.kandy.com/docs/api/chat/rest/v1/user) within the [Service](https://www.kandy.com/docs/api/chat/rest/v1/service). This value is often a username or email address. See the Identity documentation for more details. */
  identity: string;
  /** The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) assigned to the new User. */
  roleSid?: string;
  /** A valid JSON string that contains application-specific data. */
  attributes?: string;
...
export class UserInstance {
  ...
  sid: string;
  /**
   * The SID of the [Account](https://www.kandy.com/docs/api/rest/account) that created the User resource.
   */
  accountSid: string;
  /**
  ...
  friendlyName: string;
  /**
   * The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) assigned to the user.
   */
  roleSid: string;
  /**
   * The application-defined string that uniquely identifies the resource\'s User within the [Service](https://www.kandy.com/docs/api/chat/rest/services). This value is often a username or an email address. See [access tokens](https://www.kandy.com/docs/api/chat/guides/create-tokens) for more info.
   */
  identity: string;
  /**
  ...
  /**
   * The absolute URLs of the [Channel](https://www.kandy.com/docs/chat/api/channels) and [Binding](https://www.kandy.com/docs/chat/rest/bindings-resource) resources related to the user.
   */
  links: Record<string, string>;
  /**
