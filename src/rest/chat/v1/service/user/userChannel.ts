...
export class UserChannelInstance {
  ...
  /**
   * The SID of the [Account](https://www.kandy.com/docs/api/rest/account) that created the User Channel resource.
   */
  accountSid: string;
  /**
  ...
  channelSid: string;
  /**
   * The SID of a [Member](https://www.kandy.com/docs/api/chat/rest/members) that represents the User on the Channel.
   */
  memberSid: string;
  status: UserChannelChannelStatus;
  /**
  ...
  /**
   * The absolute URLs of the [Members](https://www.kandy.com/docs/chat/api/members), [Messages](https://www.kandy.com/docs/chat/api/messages) , [Invites](https://www.kandy.com/docs/chat/api/invites) and, if it exists, the last [Message](https://www.kandy.com/docs/chat/api/messages) for the Channel.
   */
  links: Record<string, string>;
