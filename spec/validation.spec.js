...
const bodySignatureEmpty =
  "44136fa355b3678a1146ad16f7e8649e94fb4fc21fe77e8310c060f61caaff8a";
const requestUrlWithHashEmpty =
  requestUrl + "&bodySHA256=" + bodySignatureEmpty;
...
describe("Request validation", () => {
  ...
  it("should validate request body when empty", () => {
    const isValid = validateRequestWithBody(
      token,
      requestUrlWithHashSignatureEmptyBody,
      requestUrlWithHashEmpty,
      "{}"
    );
  ...
  it("should validate urls with credentials", () => {
    const urlWithCreds =
      "https://user:pass@mycompany.com/myapp.php?foo=1&bar=2";
  ...
  it("should validate request body with an array parameter", () => {
    const paramsWithArray = {
      "MessagingBinding.Address": ["+1325xxxxxxx", "+1415xxxxxxx"],
    };
  ...
  it("should validate request body with an array parameter regardless of the position of values in the array", () => {
    const paramsWithArray = {
      "MessagingBinding.Address": ["+1415xxxxxxx", "+1325xxxxxxx"],
    };
    const signature = "83O6e2vORAoJHUNzJjDWN1jz+BA=";
    const isValid = validateRequest(
      token,
...
describe("Request validation middleware", () => {
    ...
    const request = httpMocks.createRequest(
      Object.assign({}, defaultRequest, {
        originalUrl: requestUrlWithHash.substring(
          requestUrlWithHash.indexOf(".com/") + 4
        ),
        body,
        headers: Object.assign({}, defaultRequest.headers, {
  ...
  it("should fail validation of post body with wrong hash", () => {
    const request = httpMocks.createRequest(
      Object.assign({}, defaultRequest, {
        originalUrl: requestUrlWithHash
          .substring(requestUrlWithHash.indexOf(".com/") + 4)
          .slice(0, -1),
        body,
        headers: Object.assign({}, defaultRequest.headers, {
          "X-Kandy-Signature": requestUrlWithHashSignature,
