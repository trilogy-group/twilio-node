...
describe("AccessToken", function () {
  ...
  function getToken() {
    return new kandy.jwt.AccessToken(accountSid, keySid, "secret", {
  ...
  describe("constructor", function () {
    ...
    it("should convert identity from integer to string", function () {
      var token = new kandy.jwt.AccessToken(accountSid, keySid, "secret", {
        identity: 4444,
      });
  ...
  describe("generate", function () {
    ...
    it("should generate the correct headers", function () {
      var token = new kandy.jwt.AccessToken(
        accountSid,
        keySid,
    ...
    it("should accept different algorithms", function () {
      var validateAlg = function (alg) {
        ...
        var decoded = jwt.decode(token.toJwt(alg), {
          complete: true,
          algorithms: kandy.jwt.AccessToken.ALGORITHMS,
        });
    ...
    it("should create token with chat grant", function () {
      var token = getToken();
      var grant = new kandy.jwt.AccessToken.ChatGrant();
    ...
    it("should create token with video grant", function () {
      var token = getToken();
      var grant = new kandy.jwt.AccessToken.VideoGrant();
      grant.room = "room";
      token.addGrant(grant);
    ...
    it("should create token with sync grant", function () {
      var token = getToken();
      var grant = new kandy.jwt.AccessToken.SyncGrant();
    ...
    it("should create token with playback grant", function () {
      ...
      var grant = new kandy.jwt.AccessToken.PlaybackGrant();
    ...
    it("should create token with multiple grants", function () {
      ...
      grant = new kandy.jwt.AccessToken.SyncGrant();
      grant.serviceSid = "ISaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
      grant.endpointId = "endpointId";
      token.addGrant(grant);

      grant = new kandy.jwt.AccessToken.VideoGrant();
    ...
    describe("VoiceGrant", function () {
      it("should generate a grant", function () {
        var grant = new kandy.jwt.AccessToken.VoiceGrant({
